...
public class BRBEmail
{
	...
	public String getCityProvincePostalCode() {
		return cityProvincePostalCode;
	}

	public void setCityProvincePostalCode(String cityProvincePostalCode) {
		this.cityProvincePostalCode = cityProvincePostalCode;
	}
