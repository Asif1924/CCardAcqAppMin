...
public class DataExtensionField  extends com.exacttarget.wsdl.partnerAPI.PropertyDefinition  implements java.io.Serializable {
    ...
    private com.exacttarget.wsdl.partnerAPI.DataExtensionFieldStorageType storageType;
    ...
    public DataExtensionField(
           ...
           com.exacttarget.wsdl.partnerAPI.DataExtensionFieldStorageType storageType) {
        super(
            client,
            partnerKey,
            partnerProperties,
    ...
    /**
     * Gets the storageType value for this DataExtensionField.
     * 
     * @return storageType
     */
    public com.exacttarget.wsdl.partnerAPI.DataExtensionFieldStorageType getStorageType() {
        return storageType;
    }


    /**
     * Sets the storageType value for this DataExtensionField.
     * 
     * @param storageType
     */
    public void setStorageType(com.exacttarget.wsdl.partnerAPI.DataExtensionFieldStorageType storageType) {
        this.storageType = storageType;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://exacttarget.com/wsdl/partnerAPI", "StorageType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://exacttarget.com/wsdl/partnerAPI", "DataExtensionFieldStorageType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
