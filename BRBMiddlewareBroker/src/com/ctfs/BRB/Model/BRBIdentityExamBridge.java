...
import com.ctfs.BRB.Helper.ScoreIdentityExamDecisions;
...
public class BRBIdentityExamBridge {
	...
	public static final String CHANNEL_NAME = "WEBIC";
		
	protected IdentityExam identityExam;
	protected AccountApplicationResponse accountAppResponse;
	 ...
	 * Constructor
	 */
	public BRBIdentityExamBridge (IdentityExam webICIdentityExam, String transactionId) {
	 ...
	 * Constructor
	 */
	public BRBIdentityExamBridge (AccountApplicationResponse accountApplicatonResponse, String transactionId) {
		accountAppResponse = accountApplicatonResponse;
		brbTransactionId = transactionId;
		identityExam = null;				
		webICResponseResult = null;
	}
    ...
    /**
	 * @return the accountAppResponse
	 */
	public AccountApplicationResponse getAccountAppResponse()
	{
		return accountAppResponse;
	}
    
    public boolean isIdentityExamModelValid () 
    {
    	return identityExam != null && identityExam.getQuestions() != null && !identityExam.getQuestions().isEmpty();
    }
    
    public Boolean doesFourthQuestionExist()
	{
		return  getWebICIdentityExam() != null && getWebICIdentityExam().getDecision() != null &&
				getWebICIdentityExam().getQuestions() != null && !getWebICIdentityExam().getQuestions().isEmpty() && 
				getWebICIdentityExam().getDecision().contains(ScoreIdentityExamDecisions.Failed4ThQuestion.toString());
	}
}
