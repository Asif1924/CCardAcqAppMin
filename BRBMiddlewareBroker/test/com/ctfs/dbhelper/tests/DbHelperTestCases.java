package com.ctfs.dbhelper.tests;
...
import com.ctfs.BRB.Helper.BRBDBHelper.Holder;
...
public class DbHelperTestCases
{
	private BRBDBHelper helper;
...
//	@Test
//	public void test_for_getDataFromCustomerTransactionTbl_method_when_resultSet_empty()throws SQLException{
//		PreparedStatement preparedStatementMock = mock(PreparedStatement.class);
//		Connection mockedConnection = mock(Connection.class);
//		helper.setConnection(mockedConnection);
//		ResultSet resultSet = mock(ResultSet.class);
...
//		
//		String sql = "SELECT TRANSACTIONID, PROFILEID, EMAIL, FIRSTNAME, LASTNAME, ADDRESSLINE1, ADDRESSLINE2, CITY, PROVINCE, POSTALCODE, PHONENUMBER, LOYALTYNUMBER, LOYALTYPROGRAM, REQUESTINGSYSTEM "
//				+ "FROM " + BRBDBHelper.BRBCUSTOMERDATATBL + " WHERE TRANSACTIONID = ?";
//		
//		when(mockedConnection.prepareStatement(sql)).thenReturn(preparedStatementMock);
//		
//		CustomerTransactionTableEntity returnedEntity = (CustomerTransactionTableEntity) helper.getDataFromCustomerTransactionTbl("1111");
//		assertEquals(returnedEntity, entity);
//	}
