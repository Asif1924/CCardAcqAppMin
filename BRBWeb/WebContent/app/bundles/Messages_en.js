...
BRB.dictionary_en = {
	...
	overview_AmIEligibleTable_Do_you_alreadyHave        :   "Do you already have a Canadian Tire Options<sup>&reg;</sup> Mastercard<sup>&reg;</sup>? It has been renamed to the Triangle<sup>&trade;</sup> Mastercard<sup>&reg;</sup>, hence you will receive the new look Triangle<sup>&trade;</sup> Mastercard<sup>&reg;</sup> on reissue.",
...
*/
	...
	//US4541
	Overview_ctm_LegalTextEComm2 									: "<span class=\"superscripts\"><sup>1</sup></span>In the form of electronic Canadian Tire Money<span class=\"superscripts\"><sup>&reg;</sup></span> (CT Money<span class=\"superscripts\"><sup>&reg;</sup></span>). Terms and conditions apply to collecting and redeeming. Visit triangle.com/ctm/ctm for more information. Triangle<span class=\"superscripts\"><sup>&trade;</sup></span> Mastercard<span class=\"superscripts\"><sup>&reg;</sup></span> and Triangle<span class=\"superscripts\"><sup>&trade;</sup></span> World Elite Mastercard<span class=\"superscripts\"><sup>&reg;</sup></span> cardmembers paying with their Triangle<span class=\"superscripts\"><sup>&trade;</sup></span> Mastercard<span class=\"superscripts\"><sup>&reg;</sup></span> and Triangle<span class=\"superscripts\"><sup>&trade;</sup></span> World Elite Mastercard<span class=\"superscripts\"><sup>&reg;</sup></span> collect Canadian Tire Money at the rate that is 10X (equates to 4%) the rate at which other members of the Triangle Rewards program collect Canadian Tire Money on purchases made by such other members at Canadian Tire stores (if other members paid by cash, debit or a credit card not linked to this loyalty program). The offered rate is exclusive of any bonus or promotional offers or redemption transactions. CT Money is collected on the pre-tax amount at Canadian Tire and PartSource.",
