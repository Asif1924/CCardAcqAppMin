...
//	overview_footnoteContentText6 						:	"<sup>&reg;</sup> CredIncorporatedit Protector and Credit Protector-Senior are owned by Canadian Tire Financial Services Limited. ",
	...
	// US3627
	personalInformation_EmailAddressNote				:	"Provide us with your email address and you'll receive a coupon for bonus e-Canadian Tire 'Money'<sup>&dagger;</sup>",
...
*/
	...
	// US3627
	personalInfo_Loyalty_Bullet1							: "Collect 10X e-Canadian Tire ‘Money’<sup>&reg;</sup> every day at Canadian Tire stores (including on automotive service), at Partsource<sup>&reg;</sup>, Mark’s / L'Equipeur<sup>&reg;</sup> and at Sportcheck<sup>&reg;1</sup>.",
	...
	// US3979
	personalInfo_Loyalty_PersonalInf_Bullet1				: "Collect 10X e-Canadian Tire ‘Money’<sup>&reg;</sup> every day at Canadian Tire stores (including on automotive service), at Partsource<sup>&reg;</sup>, Mark’s / L'Equipeur<sup>&reg;</sup> and at Sportcheck<sup>&reg;1</sup>.",
...
*/
	...
	personalInfo_LegalText1 								: "Canadian Tire Financial Services is a business name of Canadian Tire Bank. <br>" +
															  "<sup>&dagger;</sup>Cardmembers will be emailed a redeemable coupon to use at Canadian Tire stores only. The bonus e-Canadian Tire 'Money' will be added to your My Canadian Tire 'Money' account at the time of purchase. E-Canadian Tire 'Money' can then be redeemed on any future purchases providing your account is in good standing and it is a redeemable purchase.",
	personalInfo_LegalText2 								: "<sup>1</sup> In the form of e-Canadian Tire ‘Money’. Terms and conditions apply to collecting and redeeming. Visit ctfs.com/ctm for more information. Canadian Tire Options MasterCard cardmembers paying with their Options MasterCard collect e-Canadian Tire ‘Money’ at a rate that is 10X (or 2X as the case may be) the rate at which other members of the My Canadian Tire ‘Money’ program collect e-Canadian Tire ‘Money’ on purchases made by such other members at Canadian Tire stores (if those other members paid by cash, debit or a credit card not linked to this loyalty program). The offered rate is exclusive of any bonus or promotional offers or redemption transactions.",
...
*/				
	...
	// Old identityVerification_FooterText4                      	:    "<sup>&reg;</sup>/<sup>&trade;</sup> Canadian Tire, Canadian Tire Options, PartSource and the Canadian Tire triangle design are registered trademarks, and My Canadian Tire ‘Money’ and e-Canadian Tire ‘Money’ are trademarks, of Canadian Tire Corporation, Limited. ",
...
*/
	...
	Overview_ctm_LegalText1 						   			: "Canadian Tire Financial Services is a business name of Canadian Tire Bank. <br>" +
																  "<sup>1</sup> In the form of e-Canadian Tire 'Money'. Terms and conditions apply to collecting and redeeming. Visit ctfs.com/ctm for more information. Canadian Tire Options MasterCard cardmembers paying with their Options MasterCard collect e-Canadian Tire 'Money' at the rate that is 10X (or 2X as the case may be) the rate at which other members of the My Canadian Tire 'Money'<sup>&reg;</sup> program collect e-Canadian Tire 'Money' on purchases made by such other members at Canadian Tire stores (if other members paid by cash, debit or a credit card not linked to this loyalty program). The offered rate is exclusive of any bonus or promotional offers or redemption transactions.",
