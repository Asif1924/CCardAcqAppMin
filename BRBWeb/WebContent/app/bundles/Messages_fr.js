...
//		overview_footnoteContentText6						:	"<span class=\"superscriptsFootnote\"><sup>MD</sup></span> Couverture-crédit et Couverture-crédit – Âge d’or sont la propriété des Services Financiers Canadian Tire Limitée. ",
		...
		// US3627
		personalInformation_EmailAddressNote				:	"Fournissez-nous votre adresse de courriel et vous obtiendrez un coupon pour une prime d’« @rgent » Canadian Tire<sup>&dagger;</sup>.",
...
*/
		...
		additionalInformation_footnoteContentText8				:	"<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, le logo des Services Financiers Canadian Tire, Options de Canadian Tire, « @rgent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées, et Avantage Protection de Canadian Tire est une marque de commerce de La Société Canadian Tire Limitée et sont utilisées sous licence.",		
		...
		additionalInformation_footnoteContentText11				:	"<span class=\"superscripts\"><sup>MD</sup></span> Assurant est une marque de commerce déposée d’Assurant Inc.",
		additionalInformation_footnoteContentText12				:	"<span class=\"superscripts\"><sup>MD / MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées de MasterCard International Incorporated, et sont utilisées sous licence.",
...
*/
		// US3979
		personalInfo_LegalText1 								: "Services Financiers Canadian Tire est une dénomination commerciale de la Banque Canadian Tire.<br> "+
																  "<sup>&dagger;</sup>Les titulaires de carte recevront un bon par courriel, échangeable dans les magasins Canadian Tire seulement. Le montant de la prime en « @rgent » Canadian Tire sera ajouté au solde de votre compte Mon « Argent » Canadian Tire au moment de l’achat. L’« @rgent » Canadian Tire peut ensuite être échangé sur un achat ultérieur, à la condition que votre compte soit en règle et que l’achat soit admissible à l’échange de primes.",
		...
		personalInfo_LegalText4 								: "<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, le logo des Services Financiers Canadian Tire, Options de Canadian Tire, « @rgent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées de La Société Canadian Tire Limitée et sont utilisées sous licence. ",			
		personalInfo_LegalText5									: "<span class=\"superscripts\"><sup>MD / MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées de MasterCard International Incorporated, et sont utilisées sous licence.",
		...
		confirmation_Application_Authorization_Item3           :   "La carte est émise par la Banque Canadian Tire (les « SFCT »). Le programme Mon « Argent » Canadian Tire est fourni et administré par La Société Canadian Tire Limitée.",
		...
		confirmation_Application_Authorization_Item7b          :   "Je serai lié par les modalités du programme Mon « Argent » Canadian Tire décrites à l’adresse " +
																	"<a href='http://www.canadiantire.ca/fr.html' target='_blank'>canadiantire.ca</a>" +
																	" ou " +
																	"<a href='https://customer.ctfs.com/lang/fr/Products/CreditCards/OptionsMasterCard/CTMoneyRewards/' target='_blank'>ctfs.com/act</a>.",
...
*/
		// US3979
		confirmation_footnoteContentText1_1					   :   "Services Financiers Canadian Tire est une dénomination commerciale de la Banque Canadian Tire.<br>" + 
																	"<sup>&dagger;&dagger;</sup> Ces produits facultatifs sont offerts à tous les nouveaux titulaires de carte MasterCard émise par la Banque Canadian Tire. Les renseignements que vous fournissez sur la présente demande de carte sont utilisés pour déterminer votre admissibilité à l’obtention d’une carte MasterCard émise par la Banque Canadian Tire et non pour votre adhésion aux produits facultatifs, lesquels sont offerts à tous les titulaires de carte Canadian Tire.",
		confirmation_footnoteContentText01 					   :   "Payable mensuellement. Consultez votre certificat d’assurance pour connaître les modalités, les restrictions, les exclusions et les limitations. Sous réserve de certaines conditions.",
		...
		confirmation_footnoteContentText04					   :   	"<span class=\"superscripts\"><sup>MD / MC</sup></span> Sauf indication contraire, toutes les marques de commerce sont la propriété de La Société Canadian Tire Limitée et sont utilisées sous licence.",
		confirmation_footnoteContentText05					   :   	"<span class=\"superscripts\"><sup>MD / MC</sup></span> Couverture-crédit est une marque de commerce déposée de la Banque Canadian Tire.<br>" +
																	...
																	"<span class=\"superscripts\"><sup>MD</sup></span> Assurant est une marque de commerce déposée d’Assurant Inc.<br>" +	
																	"<span class=\"superscripts\"><sup>MD / MC</sup></span> MasterCard est une marque de commerce déposée de MasterCard International Incorporated, et est utilisées sous licence.",
		...
		identityVerification_FooterText4 						: "Services Financiers Canadian Tire est une dénomination commerciale de la Banque Canadian Tire. <br>" +
																  "<span class=\"superscripts\"><sup>MD</sup></span>/<span class=\"superscripts\"><sup>MC</sup></span> Sauf indication contraire, toutes les marques de commerce sont la propriété de La Société Canadian Tire et sont utilisées sous licence.",
		identityVerification_FooterText5 						: "<span class=\"superscripts\"><sup>MD</sup></span>/<span class=\"superscripts\"><sup>MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées de MasterCard International Incorporated, et sont utilisées sous licence.",
...
*/
		...
		Overview_ctm_LegalText4 							: "<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, le logo des Services Financiers Canadian Tire, Options de Canadian Tire, « @rgent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées de La Société Canadian Tire Limitée et sont utilisées sous licence.",
