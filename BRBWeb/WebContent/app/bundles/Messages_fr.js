...
*/
		...
		additionalInformation_footnoteContentText8				:	"<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, le logo des Services Financiers Canadian Tire, Options de Canadian Tire, « Argent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées, et Avantage Protection de Canadian Tire est une marque de commerce de La Société Canadian Tire Limitée et sont utilisées sous licence.",		
...
//				  												    "<span class=\"superscriptsFootnote\"><sup>MD</sup></span>/<span class=\"superscriptsFootnote\"><sup>MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées et <i>PayPass</i> est une marque de commerce de MasterCard International Incorporated.",	
		...
		// US3627
		personalInfo_Loyalty_Bullet1							: "Obtenez 10X l’« Argent »<span class=\"superscripts\"><sup>MD</sup></span> Canadian Tire tous les jours aux magasins Canadian Tire (y compris aux centres-autos) et aux magasins PartSource<span class=\"superscripts\"><sup>MD</sup></span>, Mark’s / L’Équipeur<span class=\"superscripts\"><sup>MD</sup></span> et Sport Chek<span class=\"superscripts\"><sup>MD1</sup></span>",
		personalInfo_Loyalty_Bullet2							: "Obtenez de l’« Argent » Canadian Tire dans les postes d’essence Canadian Tire participants<span class=\"superscripts\"><sup>2</sup></span>.",	
		personalInfo_Loyalty_Bullet3							: "Obtenez 2X l’« Argent » Canadian Tire partout ailleurs où vous magasinez<span class=\"superscripts\"><sup>1</sup></span>.",
		personalInfo_Loyalty_Bullet4							: "C’est facile d’échanger votre « Argent » Canadian Tire, directement à la caisse des magasins Canadian Tire.",
		// US3979
...
*/
		...
		personalInfo_LegalText4 								: "<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, le logo des Services Financiers Canadian Tire, Options de Canadian Tire, « Argent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées de La Société Canadian Tire Limitée et sont utilisées sous licence. ",			
