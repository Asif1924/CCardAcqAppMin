...
//		overview_footnoteContentText6						:	"<span class=\"superscriptsFootnote\"><sup>MD</sup></span> Couverture-crédit et Couverture-crédit – Âge d’or sont la propriété des Services Financiers Canadian Tire Limitée. ",
	...
	//	personalInformation_ReceiveEmail						:	"Je veux recevoir les communications par courriel sur les offres, les promotions et les concours ainsi que des renseignements sur les produits et services de la famille d'entreprises Canadian Tire, y compris des Services Financiers Canadian Tire et des produits d'assurance Canadian Tire. L'adresse postale de la famille d'entreprises Canadian Tire et des Services Financiers Canadian Tire est: 3475, Superior Court, Oakville (Ontario)  L6L 0C6 Ils peuvent également être joints au 1 800 459-6415. Je comprends que je peux retirer mon consentement en tout temps.",
		...
		additionalInformation_OptionalInsurance_Details16_Bullet3_OMP_OMR	:	"&#45; Payer une prestation mensuelle correspondant à 5 % du solde impayé (à l'exception des programmes des modalités spéciales de paiement) à la date du relevé coïncidant avec ou immédiatement avant la date du préjudice sur une carte de crédit émise par la Banque Canadian Tire, jusqu’à concurrence de 1 000 $ par mois et une prestation totale maximale de 20 000 $, en cas de perte involontaire de votre emploi ou d’invalidité*;",
		...
		additionalInformation_OptionalInsurance_Details16_Bullet4_OMP_OMR	:	"&#45; Payer le solde impayé de votre carte de crédit émise par la Banque Canadian Tire si vous décédez. souffrez d'une mutilation ou d'une maladie en phase terminale*, jusqu’à concurrence de 20 000 $.<b>Cette couverture offre également des prestations pour votre conjoint, sauf dans la province de Québec.</b>",
...
*/
		...
		additionalInformation_Credit_Protector_Text_OMP_OMR     :   "<span class=\"overviewNSTableRedText\">&#42;</span> J’ai lu, compris et j’accepte entièrement le <U><b><a href='https://canadiantire.scene7.com/is/content/CanadianTire/ctfs/optional_products_documents/Sommaire_des_protections_janvier_2020_francais.pdf' target='_blank'>Sommaire de la couverture et des déclarations</a></b></U> de l’assurance Couverture-crédit.",
		...
		additionalInformation_Quebec_new_lineProtectionAdvantage :  "Pour les résidents du Québec, j’ai lu et compris le <U><a href= ' https://canadiantire.scene7.com/is/content/CanadianTire/ctfs/optional_products_documents/Distribution_Guide_Quebec_janvier_2020_francais.pdf' target='_blank'>Guide de distribution</a></U> de Couverture-crédit<sup>MD</sup>.",
