...
//		overview_footnoteContentText6						:	"<span class=\"superscriptsFootnote\"><sup>MD</sup></span> Couverture-crédit et Couverture-crédit – Âge d’or sont la propriété des Services Financiers Canadian Tire Limitée. ",
		...
		additionalInformation_OptionalProducts					:	"Produits Facultatifs",
		...
		additionalInformation_OptionalInsurance_IdentityWatch   :   "- Je veux adhérer au programme Surveillance d’identité Classique<span class=\"superscripts\"><sup>MC</sup></span>",
		additionalInformation_OptionalInsurance_ProtectionAdvantage   :   "- Je veux adhérer à Avantage Protection<span class=\"superscripts\"><sup>MC</sup></span>",
		additionalInformation_OptionalInsurance_DoNotEnrolMe 	:   "- Je ne veux pas adhérer à l’assurance facultative.",
		
		
		additionalInformation_OptionalInsurance_Details			:	"<ul><li>1,10 $ par tranche de 100 $* du solde impayé du compte de carte de crédit Canadian Tire, moins le solde impayé de tout programme de modalités spéciales, plus les taxes applicables. Par exemple, si votre solde est de 200 $, vous ne payerez que 2,20 $, plus les taxes applicables. Aucune prime ne sera facturée lorsque le solde mensuel impayé de votre compte de carte de crédit Canadian Tire sera inférieur à 10 $. J’ai lu et j’accepte les <a href='https://www.ctfs.com/lang/fr/Products/Insurance/CreditProtector/CreditProtectorTandC/' target='_blank'>modalités</a>.",
		...
		additionalInformation_OptionalInsurance_Details2		:   "Protégez vos renseignements personnels, vos appareils et vos données grâce à Surveillance d’identité Classique."
																	+ "<ul><li>Service de surveillance en ligne des renseignements personnels que vous enregistrez.</li>"
																	+ "<li>Service de retour de biens* Rebound<span class=\"superscripts\"><sup>MC</sup></span> qui pourra vous aidera à récupérer les objets perdus ou volés.</li>"
																	+ "<li> Remboursement de 75 $ (CA) maximum pour mettre à jour votre ordinateur pour toute période de douze (12) mois.</li>"
																	+ "<li>De plus, la protection des cartes, la sauvegarde de données en ligne, une prime de 3 000 $ (CA) maximum liée à l’arrestation de la personne ayant volé la carte*.</li></ul>"
		...
		additionalInformation_OptionalInsurance_Details3		:   "Recevez une couverture complète grâce à la souscription à la fois au programme Couverture-crédit<span class=\"superscripts\"><sup>MD</sup></span> / Couverture-crédit – Âge d’or<span class=\"superscripts\"><sup>MD</sup></span>** et Surveillance d’identité Classique<span class=\"superscripts\"><sup>MC</sup></span>."
																	+ "<ul><li>La prime de Couverture-crédit<span class=\"superscripts\"><sup>MD</sup></span> / Couverture-crédit – Âge d’or<span class=\"superscripts\"><sup>MD</sup></span>** est de 1,10 $ par tranche de 100 $* du solde du mois courant chaque mois où le solde de votre compte est de 10 $ ou plus, et la prime de Surveillance d’identité Classique est de 4,99 $*** chaque mois; ces primes sont portées à votre compte MasterCardMD de Canadian Tire<span class=\"superscripts\"><sup>MD</sup></span>. J’ai lu et j’accepte les <a href='https://www.ctfs.com/lang/fr/Products/TermsandConditions/ProtectionAdvantage/' target='_blank'>modalités</a>.</li></ul>",
		...
		additionalInformation_footnoteContentText3				:	"Taxes applicables en sus. Payable mensuellement. Veuillez consulter le document Renseignements juridiques ou votre Certificat d’assurance pour prendre connaissance de toutes les inclusions et les exclusions relatives à votre solde.",
		additionalInformation_footnoteContentText4				:	"Si vous êtes âgé de moins de 66 ans, vous adhérerez à Couverture-crédit.",
		additionalInformation_footnoteContentText5				:	"Taxes applicables en sus. Payable mensuellement. Le programme Surveillance d’identité Classique est commandité par les Services Financiers Canadian Tire Limitée et fourni par Aimia Proprietary Loyalty Canada Inc. Si vous êtes âgé de 66 à 75 ans, vous adhérerez à Couverture-crédit – Âge d’or. Couverture-crédit et Couverture-crédit Âge d’or sont souscrites auprès de American Bankers, Compagnie d’Assurance-vie de la Floride, et de American Bankers, Compagnie d’Assurances générales de la Floride, filiales de Assurant Solutions<span class=\"superscriptsFootnote\"><sup>MD</sup></span>",
