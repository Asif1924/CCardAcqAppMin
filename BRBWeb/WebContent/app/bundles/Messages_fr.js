...
//		overview_footnoteContentText6						:	"<span class=\"superscriptsFootnote\"><sup>MD</sup></span> Couverture-crédit et Couverture-crédit – Âge d’or sont la propriété des Services Financiers Canadian Tire Limitée. ",
		...
		// US3979
		personalInformation_EmailAddressNote				:	"Fournissez-nous votre adresse de courriel et vous obtiendrez un bon échangeable contre de l’« @rgent » Canadian Tire<sup>&dagger;</sup>.",
	...
	//	personalInformation_ReceiveEmail						:	"Je veux recevoir les communications par courriel sur les offres, les promotions et les concours ainsi que des renseignements sur les produits et services de la famille d'entreprises Canadian Tire, y compris des Services Financiers Canadian Tire et des produits d'assurance Canadian Tire. L'adresse postale de la famille d'entreprises Canadian Tire et des Services Financiers Canadian Tire est: 3475, Superior Court, Oakville (Ontario)  L6L 0C6 Ils peuvent également être joints au 1 800 459-6415. Je comprends que je peux retirer mon consentement en tout temps.",
		...
		additionalInformation_OptionalInsurance_Details14_Bullet5	:	"&#45; Coût de 4,99 $** par mois, payable à l’avance au mois, après que la première transaction est effectuée sur votre carte de crédit émise par la Banque Canadian",
...
*/
		...
		additionalInformation_footnoteContentText8				:	"<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, Options de Canadian Tire, « @rgent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées, et Avantage Protection de Canadian Tire est une marque de commerce de La Société Canadian Tire Limitée et sont utilisées sous licence.",		
		additionalInformation_footnoteContentText9				:	"<span class=\"superscripts\"><sup>MD / MC</sup></span> Couverture-crédit est une marque de commerce déposée de la Banque Canadian Tire.",
		additionalInformation_footnoteContentText10				:	"Retour<span class=\"superscripts\"><sup>MD</sup></span> est une marque de commerce déposée de Fidélisation propriétaire Aimia Canada Inc.",
		additionalInformation_footnoteContentText11				:	"<span class=\"superscripts\"><sup>MD</sup></span> Assurant Solutions est une marque de commerce déposée d’Assurant Inc.",
		additionalInformation_footnoteContentText12				:	"<span class=\"superscripts\"><sup>MD / MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées de MasterCard International Incorporated.",
...
//				  												    "<span class=\"superscriptsFootnote\"><sup>MD</sup></span>/<span class=\"superscriptsFootnote\"><sup>MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées et <i>PayPass</i> est une marque de commerce de MasterCard International Incorporated.",	
		...
		personalInfo_Loyalty_Bullet1							: "Obtenez 10X l’« @rgent »<span class=\"superscripts\"><sup>MD</sup></span> Canadian Tire tous les jours aux magasins Canadian Tire (y compris aux centres-autos) et aux magasins PartSource<span class=\"superscripts\"><sup>MD</sup></span>, Mark’s / L’Équipeur<span class=\"superscripts\"><sup>MD</sup></span> et Sport Chek<span class=\"superscripts\"><sup>MD2</sup></span>",
		personalInfo_Loyalty_Bullet2							: "Obtenez de l’« @rgent » Canadian Tire dans les postes d’essence Canadian Tire participants<span class=\"superscripts\"><sup>2</sup></span>.",	
		personalInfo_Loyalty_Bullet3							: "Obtenez 2X l’« @rgent » Canadian Tire partout ailleurs où vous magasinez<span class=\"superscripts\"><sup>1</sup></span>.",
		...
		// US3979
		personalInfo_Loyalty_PersonalInf_Bullet1				: "Obtenez 10X l’« @rgent »<span class=\"superscripts\"><sup>MD</sup></span> Canadian Tire tous les jours aux magasins Canadian Tire (y compris aux centres-autos) et aux magasins PartSource<span class=\"superscripts\"><sup>MD</sup></span>, Mark’s / L’Équipeur<span class=\"superscripts\"><sup>MD</sup></span> et Sport Chek<span class=\"superscripts\"><sup>MD1</sup></span>",		
		personalInfo_CTM_label   								:"Numéro de compte Mon « Argent » Canadian Tire<span class=\"superscripts\"><sup>MD</sup></span>",
...
*/
		// US3979
		personalInfo_LegalText1 								: "<sup>&dagger;</sup>Les titulaires de carte recevront un bon par courriel, échangeable dans les magasins Canadian Tire seulement. Le montant de la prime en « Argent » Canadian Tire sera ajouté au compte de primes MasterCard Options du titulaire lorsque ce dernier effectuera un achat. La prime pourra être échangée sur un achat ultérieur, à la condition que le compte soit en règle et que l’achat soit admissible à l’échange de primes.",
		...
		personalInfo_LegalText4 								: "<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, Options de Canadian Tire, « @rgent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées de La Société Canadian Tire Limitée.",			
		personalInfo_LegalText5									: "<span class=\"superscripts\"><sup>MD / MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées de MasterCard International Incorporated.",
		...
		confirmation_Application_Authorization_Item3           :   "La carte est émise par les SFCT. Le programme Mon « Argent » Canadian Tire est fourni et administré par La Société Canadian Tire Limitée.",
...
*/
		// US3979
		confirmation_footnoteContentText01 					   :   "Taxes applicables en sus. Payable mensuellement. Consultez votre certificat d’assurance pour connaître les modalités, limitations et exclusions. Sous réserve de certaines conditions.",
		...
		confirmation_footnoteContentText02a 				   :   "Taxes applicables en sus. Vos frais d’adhésion commenceront après la première transaction effectuée à l’aide de votre carte de crédit émise par la Banque Canadian Tire. Par la suite, les frais d’adhésion seront portés en avance chaque mois à votre compte de carte de crédit de marque Canadian Tire. Consultez le document de renseignements juridiques pour connaître les modalités, les limites et les exclusions. Sous réserve de certaines conditions.",
		confirmation_footnoteContentText03 					   :   "<sup>1</sup> Primes octroyées sous forme d’« @rgent » Canadian Tire. Sous réserve de certaines modalités, conditions et restrictions. Consultez les modalités du programme à l’adresse www.ctfs.com/act pour en savoir plus.",
		confirmation_footnoteContentText04					   :	"<sup>&dagger;&dagger;</sup> Ces produits facultatifs sont offerts à tous les nouveaux titulaires de carte MasterCard émise par la Banque Canadian Tire. Les renseignements que vous fournissez sur la présente demande de carte sont utilisés pour déterminer votre admissibilité à l’obtention d’une carte MasterCard émise par la Banque Canadian Tire et non pour votre adhésion aux produits facultatifs, lesquels sont offerts à tous les titulaires de carte Canadian Tire.<br>" +
																   	"<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, Options de Canadian Tire, « @rgent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées, et Avantage Protection de Canadian Tire est une marque de commerce de La Société Canadian Tire Limitée et sont utilisées sous licence.",
		confirmation_footnoteContentText05					   :   	"<span class=\"superscripts\"><sup>MD / MC</sup></span> Couverture-crédit est une marque de commerce déposée de la Banque Canadian Tire.<br>" +
																	"Retour<span class=\"superscripts\"><sup>MD</sup></span> est une marque de commerce déposée de Fidélisation propriétaire Aimia Canada Inc.<br>" +
																	"<span class=\"superscripts\"><sup>MD</sup></span> Assurant Solutions est une marque de commerce déposée d’Assurant Inc.<br>" +	
																	"<span class=\"superscripts\"><sup>MD / MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées de MasterCard International Incorporated.",
...
*/
		...
		Overview_ctm_LegalText3 							: "<span class=\"superscripts\"><sup>3</sup></span> Si votre demande de carte à ce taux n’est pas approuvée, il se peut que nous acceptions d’émettre une carte à votre nom portant un taux d’intérêt annuel de 27,99 % pour toutes les avances de fonds et frais afférents et de 25,99 % pour tous les autres types de débit.",
		Overview_ctm_LegalText4 							: "<span class=\"superscripts\"><sup>MD / MC</sup></span> Canadian Tire, le triangle de Canadian Tire, Options de Canadian Tire, « @rgent » Canadian Tire, Mon « Argent » Canadian Tire et PartSource sont des marques de commerce déposées de La Société Canadian Tire Limitée.",
		Overview_ctm_LegalText5 							: "<span class=\"superscripts\"><sup>MD / MC</sup></span>  MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées de MasterCard International Incorporated.",
