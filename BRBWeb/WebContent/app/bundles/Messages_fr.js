...
BRB.dictionary_fr = {
		...
		overview_AmIEligibleTable_Do_you_alreadyHave        :   "Avez-vous déjà une carte Mastercard<sup>MD</sup> Options<sup>MD</sup> ? La carte Mastercard Options a été rebaptisée la carte Mastercard<sup>MD</sup> Triangle<sup>MC</sup>. Vous recevrez donc une nouvelle carte Mastercard<sup>MD</sup> Triangle<sup>MC</sup> lorsque le moment sera venu de remplacer votre carte.",
...
//		overview_footnoteContentText6						:	"<span class=\"superscriptsFootnote\"><sup>MD</sup></span> Couverture-crédit et Couverture-crédit – Âge d’or sont la propriété des Services Financiers Canadian Tire Limitée. ",
		...
		personalInformation_EmailAddress						:	"Adresse de courriel",
	//	personalInformation_ReceiveEmail						:	"Je veux recevoir les communications par courriel sur les offres, les promotions et les concours ainsi que des renseignements sur les produits et services de la famille d'entreprises Canadian Tire, y compris des Services Financiers Canadian Tire et des produits d'assurance Canadian Tire. L'adresse postale de la famille d'entreprises Canadian Tire et des Services Financiers Canadian Tire est: 3475, Superior Court, Oakville (Ontario)  L6L 0C6 Ils peuvent également être joints au 1 800 459-6415. Je comprends que je peux retirer mon consentement en tout temps.",
		...
		personalInformation_EmploymentInformation				:	"<b>Renseignements professionnels</b>",
...
*/
		...
		// US4997 - OMP CARD
		confirmation_Application_Authorization__OMP_CARD_Item2        :   "<b><p>S’il ne si votre demande de carte n’est pas approuvée aux taux susmentionnés, la Banque Canadian Tire peut quand même vous émettre une carte aux taux d’intérêt annuels suivants :</p><p>(i) si vous êtes un résident du Québec, <b>22,99 &#37;</b> pour tous les frais; ou</p><p>(ii) si vous résidez à l’extérieur du Québec, <b>25,99 &#37;</b> pour tous les frais (à l’exception des transactions au comptant et des frais afférents) et <b>27,99 &#37;</b> pour les transactions au comptant et les frais afférents. sera de <b>27,99 &#37;</b>.</p></b>",
...
//				  												    "<span class=\"superscriptsFootnote\"><sup>MD</sup></span>/<span class=\"superscriptsFootnote\"><sup>MC</sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées et <i>PayPass</i> est une marque de commerce de MasterCard International Incorporated.",	
		...
		Overview_NS_DisclosureRight1_DEC_OMR                       :  "<p>Les taux d’intérêt ci-dessous seront en vigueur à compter de la date d’ouverture de votre compte.</p><p>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <strong>19,99 %.</strong></p><p>Transactions au comptant (avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <strong>22,99 %.</strong></p><p>Si votre demande de carte n’est pas approuvée aux taux susmentionnés, la Banque Canadian Tire peut quand même vous émettre une carte aux taux d’intérêt annuels suivants :</p><p>(i) si vous êtes un résident du Québec, <strong>22,99 %</strong> pour tous les frais; ou</p><p>(ii) si vous résidez à l’extérieur du Québec, <strong> 25,99 %</strong> pour tous les frais (à l’exception des transactions au comptant et des frais afférents) et <strong>27,99 %</strong> pour les transactions au comptant et les frais afférents. sera de <strong>27,99 %.</strong></p>",
		...
		Overview_NS_DisclosureRight3                               :   "<p>Si vous résidez dans une autre province que le Québec, le paiement minimum correspondra à la somme : " +
																		"<br>(A) des intérêts et des frais figurant sur votre relevé; plus" +
																		"<br>(B) tout montant en souffrance ou, s’il est plus élevé, tout montant qui excède votre limite de crédit; plus" +
																		"<br>(C) le montant de tous les versements échelonnés en vertu de programmes de paiements égaux alors dus; plus (D) <strong>10 $.</strong>" +
																		"<br>Un solde inférieur à <strong>10 $</strong> doit être réglé intégralement." +
																		"<br><br>Si vous résidez dans la province de Québec, le paiement minimum correspondra à la somme :" +
																		"<br>(A) du plus élevé des montants suivants,à savoir : (i) les intérêts et les frais figurant sur votre relevé plus <strong>10 $</strong>, ou (ii) <strong>5 %</strong> du nouveau solde, à l’exclusion des montants dus aux termes de programmes de modalités spéciales de paiement; plus" +
		...
		Overview_NS_DisclosureRight3_OMP                           :   "<p>Si vous résidez dans une autre province que le Québec, le paiement minimum correspondra à la somme :</p><p>La somme : (A) des intérêts et des frais figurant sur votre relevé; plus</p><p>(B) tout montant en souffrance ou, s’il est plus élevé, tout montant qui excède votre limite de crédit; plus</p><p>(C) le montant de tous les versements échelonnés en vertu de programmes de paiements égaux alors dus; plus (D) <strong>10 $. </strong></p><p>Un solde inférieur à  <strong>10 $ </strong> doit être réglé intégralement.</p><br><p>Pour les résidents de la province de Québec :</p><p>La somme : (A) du plus élevé des montants suivants,à savoir : (i) les intérêts et les frais figurant sur votre relevé plus <strong> 10 $ </strong>, ou (ii) <strong>5 % </strong>du nouveau solde, à l’exclusion des montants dus aux termes de programmes de modalités spéciales de paiement, plus</p><p>(B) tout montant qui excède votre limite de crédit, plus</p><p>(C) tout montant en souffrance qui n’est pas inclus dans le montant (B) ci-dessus, plus</p><p>(D) le montant de tous les versements échelonnés en vertu de programmes de paiements égaux alors dus.</p><p>Un solde inférieur à  <strong>10 $</strong> doit être réglé intégralement.</p>",
		Overview_NS_DisclosureRight3_OMR                           :   "<p>Si vous résidez dans une autre province que le Québec, le paiement minimum correspondra à la somme :</p><p>La somme : (A) des intérêts et des frais figurant sur votre relevé; plus</p><p>(B) tout montant en souffrance ou, s’il est plus élevé, tout montant qui excède votre limite de crédit; plus</p><p>(C) le montant de tous les versements échelonnés en vertu de programmes de paiements égaux alors dus; plus (D) <strong>10 $. </strong></p><p>Un solde inférieur à  <strong>10 $ </strong> doit être réglé intégralement.</p><br><p>Pour les résidents de la province de Québec :</p><p>La somme : (A) du plus élevé des montants suivants,à savoir : (i) les intérêts et les frais figurant sur votre relevé plus <strong> 10 $ </strong>, ou (ii) <strong>5 % </strong>du nouveau solde, à l’exclusion des montants dus aux termes de programmes de modalités spéciales de paiement, plus</p><p>(B) tout montant qui excède votre limite de crédit, plus</p><p>(C) tout montant en souffrance qui n’est pas inclus dans le montant (B) ci-dessus, plus</p><p>(D) le montant de tous les versements échelonnés en vertu de programmes de paiements égaux alors dus.</p><p>Un solde inférieur à  <strong>10 $</strong> doit être réglé intégralement.</p>",
		...
		Overview_NS_DisclosureRight6                            :   "<p><strong>Frais d’avances de fonds : 4 $</strong> — Facturés à la date à laquelle la transaction est inscrite à votre compte.</p><p><strong>Frais pour chèque sans provision ou refusé : 25 $</strong> — Imputés si un paiement que vous effectuez est refusé.</p><p><strong>Frais pour copie de remplacement : 2 $</strong> – Imputés lorsque vous demandez une copie d’un relevé. </p><p><strong>Administration du solde créditeur :</strong> Le moindre de <strong>10 $</strong> ou du montant de votre solde créditeur. Imputés le dernier jour d’une période de facturation lorsque le compte comporte un solde créditeur et qu’il a été inactif au cours des <strong>12</strong> périodes de facturation précédentes.</p>",
...
*/
		...
		confirmation_Application_Authorization_Item2_OMX           :   "<p>Si votre demande de carte n’est pas approuvée aux taux susmentionnés, la Banque Canadian Tire sans préavis, traite cette demande comme une demande distincte pour la même carte peut quand même vous émettre une carte aux taux d’intérêt annuels suivants:</p>  <p>(i) si vous êtes un résident du Québec, <strong>22,99 %</strong> pour tous les frais; ou</p> <p>(ii) si vous résidez à l’extérieur du Québec, <strong>25,99 %</strong> pour tous les frais  (à l’exception des transactions au comptant et des frais afférents) et <strong>27,99 %</strong> pour les transactions au comptant et les frais afférents.</p>",
...
*/
		...
		Overview_ctm_LegalTextEComm7_newLine_1                  : "<span class=\"superscripts\"><sup>&#8224;</sup></span> Assurance Achats, Garantie prolongée et l’Assurance collision/dommages pour véhicules de location sont des assurances souscrites auprès de American Bankers Compagnie d’Assurance générale de la Floride. Les services de conciergerie sont proposés par Services Assurant Canada Inc. Le détails des services et de la couverture d’assurance, y compris les définitions, les avantages, les limites et les exclusions sont décrites dans le certificat d’assurance et l’énoncé des services fournis avec votre carte. Veuillez conserver ces documents en lieu sûr avec vos autres documents importants et prenez les avec vous en voyage. American Bankers Compagnie d’Assurance Générale, leurs filiales et sociétés affiliées, exercent des activités au Canada sous le nom Assurant<span class=\"superscripts\"><sup>MD</sup></span>.",
		...
		Overview_ctm_LegalText_OIC_OMP_Card_Text6                       :   "<b>Renseignements supplémentaires à l’intention des résidents du Québec seulement : </b> Le taux annuel courant applicable aux personnes qui demandent la carte Mastercard<span class=\"superscripts\"><sup>MD</sup></span> Avantage Essence<span class=\"superscripts\"><sup>MD</sup></span> est de 22,99 &#37; pour les transactions au comptant et les frais afférents et de 19,99 &#37; pour tous les autres types de débit. Certaines personnes peuvent se voir accorder un taux annuel courant supérieur ou inférieur, selon les résultats de leur évaluation de crédit. Pour les nouveaux demandeurs, le paiement minimum correspondra à la somme (A) du plus élevé des montants suivants, à savoir (i) les intérêts et les frais figurant sur votre relevé plus 10 &#36;, ou (ii) 5 &#37; du nouveau solde, à l’exclusion des montants dus aux termes de programmes de modalités spéciales de paiement; plus (B) tout montant qui excède votre limite de crédit; plus (C) tout montant en souffrance qui n’est pas inclus dans le montant (B) ci dessus; plus (D) le montant de tous les versements échelonnés en vertu de programmes de paiements égaux alors dus. Un solde inférieur à 10 &#36; doit être réglé intégralement. Pour les résidents du Québec, le délai de grâce entre la date du relevé et la date d’échéance du paiement est de 26 jours. La période de facturation couverte par chaque relevé peut aller de 28 à 33 jours. La carte Mastercard<span class=\"superscripts\"><sup>MD</sup></span> Avantage Essence<span class=\"superscripts\"><sup>MD</sup></span> ne comporte aucun frais annuel. Exemples de coûts d’emprunt (arrondis au cent le plus proche) en supposant que tous les débits portent intérêt au taux annuel courant de 19,99 &#37;, que le mois comporte 30 jours, qu’aucun achat ne fait l’objet d’un programme de modalités spéciales de paiement et qu’aucuns autres frais, paiements additionnels ou changements ne s’appliquent :",
		...
		Overview_ctm_LegalText_OIC_OMR_Card_Text6                       :   "<b>Renseignements supplémentaires à l’intention des résidents du Québec seulement : </b>Le taux annuel courant applicable aux personnes qui demandent la carte Mastercard<span class=\"superscripts\"><sup>MD</sup></span> Avantage Remise<span class=\"superscripts\"><sup>MD</sup></span> est de 22,99 &#37; pour les transactions au comptant et les frais afférents et de 19,99 &#37; pour tous les autres types de débit. Certaines personnes peuvent se voir accorder un taux annuel courant supérieur ou inférieur, selon les résultats de leur évaluation de crédit. Pour les nouveaux demandeurs, le paiement minimum correspondra à la somme (A) du plus élevé des montants suivants, à savoir (i) les intérêts et les frais figurant sur votre relevé plus 10 &#36;, ou (ii) 5 &#37; du nouveau solde, à l’exclusion des montants dus aux termes de programmes de modalités spéciales de paiement; plus (B) tout montant qui excède votre limite de crédit; plus (C) tout montant en souffrance qui n’est pas inclus dans le montant (B) ci dessus; plus (D) le montant de tous les versements échelonnés en vertu de programmes de paiements égaux alors dus. Un solde inférieur à 10 &#36; doit être réglé intégralement. Pour les résidents du Québec, le délai de grâce entre la date du relevé et la date d’échéance du paiement est de 26 jours. La période de facturation couverte par chaque relevé peut aller de 28 à 33 jours. La carte Mastercard<span class=\"superscripts\"><sup>MD</sup></span> Avantage Remise<span class=\"superscripts\"><sup>MD</sup></span> ne comporte aucun frais annuel. Exemples de coûts d’emprunt (arrondis au cent le plus proche) en supposant que tous les débits portent intérêt au taux annuel courant de 19,99 &#37;, que le mois comporte 30 jours, qu’aucun achat ne fait l’objet d’un programme de modalités spéciales de paiement et qu’aucuns autres frais, paiements additionnels ou changements ne s’appliquent :",
