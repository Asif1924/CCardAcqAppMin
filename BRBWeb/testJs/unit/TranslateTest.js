describe("Translation Test", function() {
	...
	beforeEach(function() {
		...
		realDictionary_en = BRB.dictionary_en;
		realDictionary_fr = BRB.dictionary_fr;
		...
		sut = new BRB.Translate(translationLibrary, BRB.AppConfig.LanguageEnum);
		
		// or else it will use the stored default
		window.localStorage.removeItem("BRB_PERSIST_LANGUAGE");
	});	
	
	afterEach(function() {
		BRB.dictionary_en = realDictionary_en;
		BRB.dictionary_fr = realDictionary_fr;
	});
