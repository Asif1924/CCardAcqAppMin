...
public class PersInfoPageTellUsAboutYourselfStreetNumber extends BaseTest{
	
	@Test
	public void persInfo055() throws Exception {
	...
	@Test
	public void persInfo057() throws Exception {
		WebElement streetnumber = PersInfoPageTellUsAboutYourself.get().StreetNumberTextField;
