...
CREATE TABLE "WEBIC_OWNER"."CUSTOMERTRANSACTION"
 ...
 NOCYCLE; 
  ...
  -- execute as webic_owner user 
grant select, insert, update, delete on CUSTOMERTRANSACTION to webic_app; 
GRANT SELECT ON ICSEQ_WEBIC_ECOM_SEED_ID TO WEBIC_APP; 
COMMIT;  
  
  -- execute as webic_app user 
CREATE SYNONYM WEBIC_APP.CUSTOMERTRANSACTION FOR webic_owner.CUSTOMERTRANSACTION; 
CREATE SYNONYM WEBIC_APP.ICSEQ_WEBIC_ECOM_SEED_ID FOR webic_owner.ICSEQ_WEBIC_ECOM_SEED_ID; 
COMMIT; 
...
grant select, insert, update, delete on APPLICATIONTRANSACTION to webic_app; 
GRANT SELECT ON ICSEQ_WEBIC_ECOM_SEED_ID TO WEBIC_APP; 
COMMIT; 

  -- execute as webic_app user 
CREATE SYNONYM WEBIC_APP.APPLICATIONTRANSACTION FOR WEBIC_OWNER.APPLICATIONTRANSACTION; 
COMMIT; 
...
COMMIT;  
 ...
 -- execute as webic_owner user 
grant select, insert, update, delete on BRB_APP_STATE to webic_app; 
GRANT SELECT ON ICSEQ_WEBIC_ECOM_SEED_ID TO WEBIC_APP; 
COMMIT;  

  -- execute as webic_app user 
CREATE SYNONYM WEBIC_APP.BRB_APP_STATE FOR webic_owner.BRB_APP_STATE; 
  -- If not created yet
CREATE SYNONYM WEBIC_APP.ICSEQ_WEBIC_ECOM_SEED_ID FOR webic_owner.ICSEQ_WEBIC_ECOM_SEED_ID; 
COMMIT; 
...
-- execute as webic_owner user 
grant select, insert, update, delete on BRB_APP_SCREEN to webic_app; 
GRANT SELECT ON ICSEQ_WEBIC_ECOM_SEED_ID TO WEBIC_APP; 
COMMIT;  

-- execute as webic_app user 
CREATE SYNONYM WEBIC_APP.BRB_APP_SCREEN FOR webic_owner.BRB_APP_SCREEN; 
...
-- execute as webic_owner user 
grant select, insert, update, delete on BRB_STATE_TRACKER to webic_app; 
GRANT SELECT ON ICSEQ_WEBIC_ECOM_SEED_ID TO WEBIC_APP; 
COMMIT;  

-- execute as webic_app user 
CREATE SYNONYM WEBIC_APP.BRB_STATE_TRACKER FOR webic_owner.BRB_STATE_TRACKER; 
