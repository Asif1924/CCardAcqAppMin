...
GENERICWEBAPP.BaseModel = function(config) {

    this.name = config.name;
    this.data = config.data;
    this.refs = config.refs;
    var refs = this.refs;
    var validator = new GENERICWEBAPP.Validator();
    var logPrefix = '[GENERICWEBAPP.BaseModel ('+this.name+')]:: ';
    //---------------------------------------------------------------
    ...
    var isValid = function(validation, name, value){
        ...
        if(isError){
            ...
            console.log('GENERICWEBAPP.BaseModel::isValid() name:'+rez.name+'  err:'+rez.err+'  uiid:'+rez.uiid);
        }
        return rez;
    };
    //---------------------------------------------------------------
    this.validate = function(groupName) {
        console.log('GENERICWEBAPP.BaseModel::isGroupValid(' + groupName + ')');
    ...
    {
    	console.log('GENERICWEBAPP.BaseModel::ValidateFieldByName(' + fieldName + ')');
    	var result = [];
    ...
    this.validateAge = function(model, province) {
		...
		console.log('GENERICWEBAPP.BaseModel::validateEdge FullYears=' + fullYears);
