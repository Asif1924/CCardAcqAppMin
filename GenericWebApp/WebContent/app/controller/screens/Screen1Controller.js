...
GENERICWEBAPP.Screen1Controller = function(argLoanApplicationData, argTranslator, argMessageDialog) {
    var logPrefix = '[GENERICWEBAPP.Screen1Controller]::';
    var $screenContainer = $("#Screen1");
    var translator = null;
    ...
    function createView() {
        ...
        assembleHTML($screenContainer, "#Screen1-template");
    }
    ...
    function bindEvents() {
        ...
        $('#screen1Next').click(function(){
        	app.flow.next();
        });
        $('#screen1Back').click(function(){
        	app.flow.back();
        });    
	}
};