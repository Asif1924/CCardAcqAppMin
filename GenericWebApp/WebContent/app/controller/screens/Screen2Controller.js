...
GENERICWEBAPP.Screen2Controller = function(argLoanApplicationData, argTranslator, argMessageDialog) {
    var logPrefix = '[GENERICWEBAPP.Screen2Controller]::';
    var $screenContainer = $("#Screen2");
    var translator = null;
    ...
    function createView() {
        ...
        assembleHTML($screenContainer, "#Screen2-template");
    }
    ...
    function bindEvents() {
        ...
        $('#screen2Next').click(function(){
        	app.flow.next();
        });
        $('#screen2Back').click(function(){
        	app.flow.back();
        });    
    }
};