describe("Validator", function() {
	...
	beforeEach(function() {
		sut = new EASYFINANCIAL.Validator();
	});
	
	describe("- Common value validation", function() {
	
		it("will parse JSON String into Object", function() {
			
			var jsonString = "{ MfgSerial : \"20:50\", BuildSerial : \"213123213\" }"; 

			var jsonOBJ = eval('('+jsonString+')' );
			
			expect(jsonOBJ.MfgSerial).toEqual("20:50");
        ...
        it("will make sure string has mod10", function() {
            expect(sut.mod10(23, 2)).toBeFalsy();
        });
	...
	describe("- Email validation", function() {
		...
		it("will allow correct email addresses", function() {
			...
			expect(sut.emailAddress("someone-lastname+tag@somewhere")).toBeFalsy();
		});
	});
