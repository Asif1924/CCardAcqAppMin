...
WICI.FinancialScreenController = function(activationItems, argTranslator,
	...
	/*
	 * flipVISAMCAMEX_NO,flipBankLoan_no,flipStoreCard_no,flipStoreCard_no,flipChequingAcct_no,flipGasCard_no,flipSavingsAcct_no
	 * id="flipVISAMCAMEX_NO" flipVISAMCAMEX_YES flipBankLoan_no
	 * flipBankLoan_yes flipStoreCard_no flipStoreCard_yes flipChequingAcct_no
	 * flipChequingAcct_yes
	 */
	...
	function createFlips() {
		$(
				...
				.text(translator.translateKey("messageDialog_no"));
		$(
				...
				.text(translator.translateKey("messageDialog_yes"));
	...
	function populateJobCategories() {
		...
		if(jobCategoryVal){
			$(refs.jobCategory + " [value='" + jobCategoryVal + "']").attr("selected",
			"selected");
		}
	}
	// ---------------------------------------------------------------------------------------
	...
	function bindEvents() {
		...
		$(refs.jobCategory).bind('translatorFinished', function(event) {
			console.log(refs.jobCategory + 'bind(translatorFinished)');
			populateJobCategories();	
			$(refs.jobCategory).val(model.get("jobCategory"));
		});
