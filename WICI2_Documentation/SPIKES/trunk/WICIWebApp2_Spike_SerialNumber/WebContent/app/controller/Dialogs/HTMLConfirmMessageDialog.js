...
WICI.HTMLConfirmMessageDialog = function(message, yesCallback, noCallback, title, yesButton, noButton){
	...
	function appendDialog(){
		$("#htmlConfirmMessageDialog-template").template("dialogTemplate");
		$.tmpl("dialogTemplate", {
			title : title,
			message : message,
			yesButton : yesButton,
