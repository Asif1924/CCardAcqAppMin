...
public class UserLocationServlet extends WICIServlet
{
	...
	protected void handleRequest(WICIServletMediator requestMediator) throws ServletException, IOException
	{
		...
		try
		{
			...
			String userId = requestMediator.isHttpGetRequestParameterExist("userId") ? requestMediator.getHttpGetRequestParameter("userId") : EMPTY_STRING;
			String locationId = requestMediator.isHttpGetRequestParameterExist("locationId") ? requestMediator.getHttpGetRequestParameter("locationId") : EMPTY_STRING;
