...
public class WICIDBHelper
{
	...
	static final String APPROVED_CONFIG_NAME = "APPROVED_APK_VERSION";
	...
	public IConfigurationTableEntity getDataFromConfigurationTbl(String apkVersion) throws SQLException
	{
		String sMethod = "[getDataFromConfigurationTbl] ";
		log.info(sMethod + "::Called with parameter apkVersion:" + apkVersion);

		IConfigurationTableEntity configurationTableEntity = null;	
		
		// Create sql statement
		String sql = "SELECT CONFIG_NAME, CONFIG_VALUE FROM " + WICICONFIGTBL + 
					 " WHERE CONFIG_VALUE = ? AND CONFIG_NAME = ?";
		...
		try
		{
			...
			preparedStatement.setString(2, APPROVED_CONFIG_NAME);
	...
	public String insertAccountApplicationData (String transactionID, String userID, String requestData) throws Exception{
		...
		// Create sql statement
		String sql = "INSERT INTO " + WICIREQUESTQUEUETBL + 
		"(TRANSACTION_ID, TRANSACTION_TYPE, TRANSACTION_STATE, USER_ID, PROCESS_DATE, REQUEST_DATA)" +
