...
public class InitAccountApplicationServletMock extends HttpServlet {
	private 		static 		final 		long 			serialVersionUID 		= 2L;
	static 									Logger 			log 					= Logger.getLogger(InitAccountApplicationServletMock.class.getName());

    public InitAccountApplicationServletMock() {
        super();
    }
