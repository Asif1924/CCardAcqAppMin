...
WICI.SettingsDialog = function(isAdminProfile, logOutCallback, chooseProductCallback, printerSetupCallback, title, 
	...
	function addEvents(showNextDialogCallback){
		...
		$("#" + dialogViewHelper.getMessageDialogId()).one('pagehide.DART', function(){
			...
			try {
				...
				console.log("Internal WICI error after Settings dialog box");
			}
			showing = false;
