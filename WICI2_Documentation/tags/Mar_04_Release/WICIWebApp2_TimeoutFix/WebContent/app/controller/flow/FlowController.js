				...
				{  
		            if($(item).attr('inited')!='true')
		            {
		            	...
		            	$(item).click(function() {
		    				...
		    				{
		    					messageDialog.settings(app.accountProfileHelper.isAdminProfile(), logOutClick, null, printerSetupClick);
		    				}
		    				else
		    				{
		    					messageDialog.settings(app.accountProfileHelper.isAdminProfile(), logOutClick, chooseProductClick, printerSetupClick);
		    				}	
		    	        });
		            }
	        });
