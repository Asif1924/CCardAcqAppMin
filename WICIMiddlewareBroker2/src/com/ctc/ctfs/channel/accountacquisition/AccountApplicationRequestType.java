 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="costOfCreditFlag" minOccurs="0">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.channel.ctfs.ctc.com/accountAcquisition/}UpperCaseStringType">
 *               &lt;maxLength value="1"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="cardMemberFlag" minOccurs="0">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.channel.ctfs.ctc.com/accountAcquisition/}UpperCaseStringType">
 *               &lt;maxLength value="1"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="triangleRewardFlag" minOccurs="0">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.channel.ctfs.ctc.com/accountAcquisition/}UpperCaseStringType">
 *               &lt;maxLength value="1"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="controlConfirmationFlag" minOccurs="1">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.channel.ctfs.ctc.com/accountAcquisition/}UpperCaseStringType">
 *               &lt;maxLength value="1"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="controlConfirmationSignature" type="{http://www.w3.org/2001/XMLSchema}base64Binary"/>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="DSAScore" minOccurs="0">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.channel.ctfs.ctc.com/accountAcquisition/}UpperCaseStringType">
 *               &lt;maxLength value="3"/>
 *             &lt;/restriction>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="tmxProfileId" minOccurs="0">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.channel.ctfs.ctc.com/accountAcquisition/}UpperCaseStringType">
 *               &lt;maxLength value="3"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="PIISource" minOccurs="0">
 *           &lt;simpleType>
 *             &lt;restriction base="{http://www.channel.ctfs.ctc.com/accountAcquisition/}UpperCaseStringType">
 *               &lt;maxLength value="3"/>
 *             &lt;/restriction>
    ...
    implements Serializable
{
    ...
    @XmlElement(required = true)
    protected String controlConfirmationFlag;
    @XmlElement(required = true)
    protected String costOfCreditFlag;
    @XmlElement(required = true)
    protected String cardMemberFlag;
    @XmlElement(required = true)
    protected String triangleRewardFlag;
    @XmlElement(required = true)
    protected byte[] controlConfirmationSignature;
    @XmlElement(required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String DSAScore;
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String treatmentCode;
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String tmxProfileId;
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String PIISource;
    @XmlElement(required = true)
	...
	public String toString() {
		return "AccountApplicationRequestType ["
				+ "externalReferenceId=" + externalReferenceId + ", storeNumber=" + storeNumber
				...
				+ ", controlConfirmationSignature=" + Arrays.toString(controlConfirmationSignature)
				+ ", costOfCreditFlag=" + costOfCreditFlag
				+ ", cardMemberFlag=" + cardMemberFlag
				...
				+ ", supp1AddressLine2=" + supp1AddressLine2 + ", supp1City=" + supp1City 
				+ ", supp1Province=" + supp1Province
				+ ", supp1PostalCode=" + supp1PostalCode + ", supp1Country=" + supp1Country 
				+ ", supp1TelephoneNumber=" + supp1TelephoneNumber + ", agreedToTermsFlag=" + agreedToTermsFlag 
				+ ", applicantSignature=" + Arrays.toString(applicantSignature) + ", signatureFlag=" + signatureFlag 
				+ ", signatureMatchFlag=" + signatureMatchFlag
				+ ", dateSigned=" + dateSigned + ", insuranceAgreedFlag=" + insuranceAgreedFlag 
				+ ", insuranceAgreedFlag_CP=" + insuranceAgreedFlag_CP + ", insuranceAgreedFlag_IW=" + insuranceAgreedFlag_IW 
				...
				+ ", insuranceSignature=" + Arrays.toString(insuranceSignature)
				+ ", insuranceSignatureCP=" + Arrays.toString(insuranceSignatureCP)
				+ ", insuranceSignatureIW=" + Arrays.toString(insuranceSignatureIW) + ", affiliationCode=" + affiliationCode 
				+ ", acquirerCode=" + acquirerCode
				+ ", tuSessionID=" + tuSessionID + ", tuExamResult=" + tuExamResult 
				+ ", emailConsentFlag=" + emailConsentFlag
				+ ", enstreamConsent=" + enstreamConsent + ", msisdn=" + msisdn
				+ ", pan=" + pan + ", admAppId=" + admAppId + ", unitNumber=" + unitNumber 
