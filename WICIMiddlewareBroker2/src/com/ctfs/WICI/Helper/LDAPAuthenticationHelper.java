...
public class LDAPAuthenticationHelper
{
	...
	public LDAPResponse authenticateToLDAP(HttpServletRequest argTabletRequest)
	{
		...
		try
		{
			UrlEncodedFormEntity urlEncodedFormEntity = new UrlEncodedFormEntity(loginCredentials, HTTP.UTF_8);
			httpPOSTRequestToLDAPURL.setEntity(urlEncodedFormEntity);
		}
		...
		ldapResponse.setHttpStatusCode(statusCode);
		return ldapResponse;
	}
}
