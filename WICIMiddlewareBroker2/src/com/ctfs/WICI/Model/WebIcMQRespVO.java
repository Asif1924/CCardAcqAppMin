...
public class WebIcMQRespVO
{
	...
	protected String hostAvailCode;
	...
	public String getHostAvailCode() {
		return hostAvailCode;
	}
	public void setHostAvailCode(String hostAvailCode) {
		this.hostAvailCode = hostAvailCode;
	}
