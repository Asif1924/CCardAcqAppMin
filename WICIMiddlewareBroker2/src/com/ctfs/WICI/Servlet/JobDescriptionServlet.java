...
public class JobDescriptionServlet extends WICIServlet {
	private static final long serialVersionUID = 1L;
	
	static Logger log = Logger
			.getLogger(JobDescriptionServlet.class.getName());

	public JobDescriptionServlet() {
	...
	public  JobDescriptionOutput  retriveJobDescriptionHttpClientCall(){
         ...
         // String endPoint = "http://d9cbwpdssa01:8765/wici/v1/retrieveJobDescriptionValues";
           log.info(sMethod);
		 try{
			 WICIConfiguration conf = new WICIConfigurationFactory().createDASSEndPointConfiguration();
	        ...
	        if( jobDescriptionResponse != null ){
	        	log.info(sMethod + "jobDescriptionResponse Response "+ jobDescriptionResponse);
	...
	/*public static void main(String args[]) throws Exception {
		...
		retriveJobDescriptionHttpClientCall();
