...
WICI.dictionary_fr = {
	...
	optionalProducts_IdentityWatch_Title				:	"<strong>Surveillance d'identité Classique<span class=\"MC\"><sup></sup></span></strong>",

	optionalProducts_TermsAndConditions_PA_Title		:	"<strong>Modalités relatives au programme Avantage Protection<span class=\"MC\"><sup></sup></span> de Canadian Tire</strong>",
    ...
    optionalProducts_TermsAndConditions25              :    "<br><sup>&#8224;&#8224;</sup> Ces produits facultatifs sont offerts à tous les nouveaux titulaires de carte MasterCard de Canadian Tire. Les renseignements que vous fournissez sur la présente demande de carte sont utilisés pour déterminer votre admissibilité à l'obtention d'une carte MasterCard de Canadian Tire et non pour votre adhésion aux produits facultatifs, lesquels sont offerts à tous les titulaires de carte Canadian Tire." +
                                                            ...
                                                            "<br><br><span class=\"MD\"><sup></sup></span>/<span class=\"MC\"><sup></sup></span> Couverture-crédit et Couverture-crédit – <i>Âge d'or</i> sont des marques de commerce déposées de la Banque Canadian Tire." +
                                                            "<br><br>Rebound<span class=\"MD\"><sup></sup></span> est une marque de commerce déposée de Fidélisation propriétaire Aimia Canada Inc." +
                                                            "<br><br><span class=\"MD\"><sup></sup></span> Assurant Solutions est une marque de commerce de Assurant Inc." +
                                                            "<br><br><span class=\"MD\"><sup></sup></span>/<span class=\"MC\"><sup></sup></span> MasterCard et la marque figurative de MasterCard sont des marques de commerce déposées et <i>PayPass</i> est une marque de commerce de MasterCard International Incorporated.",
    optionalProducts_TableTitle                         :   "OUI, JE SOUHAITE ADHÉRER AUX PRODUITS FACULTATIFS SUIVANTS:",
