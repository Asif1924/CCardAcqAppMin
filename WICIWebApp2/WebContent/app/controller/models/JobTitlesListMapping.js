...
WICI.JobTitlesListMapper = function() {
    this.data= [
			//TRADERS
			...
			{ value: 'ST_ST', text: 'STUDENT'}
        ];
    //----------------------------------------------------------------------------------
    this.getJobTitleByJobValue = function(value){
        var sMethod = '[getJobtitleByJobValue()] ';
        ...
        var filteredData="";
        var joinRule = new WICI.JobTitlesListMapper();
