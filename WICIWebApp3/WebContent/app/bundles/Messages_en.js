...
WICI.dictionary_en =  {
   ...
   // chooseProduct_Triangle_Rewards 					    : 	"Triangle  Rewards<sup>&trade;</sup>",
	...
	chooseProduct_CanadianTireAgreementTitle            : "Canadian Tire Bank Card Member Agreement",
	chooseProduct_CanadianTireAgreement_para1           : "The agreement (also referred to as <b>this agreement</b>) between you, as primary cardmember, and us, as issuer of each card, includes the terms in this document, any amendment to or replacement of these terms, any specific instructions that we provide to you in writing about the use of a card and the disclosure statement that we provide to you with a card. Unless we notify you otherwise, this agreement applies to every card (as defined below) that we have issued or may issue in the future to you or to any supplementary cardmember and replaces any prior agreement relating to a card. The terms of this agreement apply as soon as we open an account even though you may not have received a card.",
    chooseProduct_CanadianTireAgreement_para2           : "<b><U>Definitions You Need to Know</U></b><br><b>we</b>, <b>our</b> and <b>us</b> means Canadian Tire Bank.<b>you</b> and <b>your</b> refer to the <b>primary cardmember</b>, who is the person in whose name the account for a particular card has been opened.<b>account</b> means an account that is opened in your name, either with respect to a particular card or on a temporary basis to enable you to make charges before you receive a card. <b>balance due</b> means the amount shown as the balance due on your monthly statement. <b>balance transfer</b> means the payment by us on your behalf to someone else of any indebtedness that you owe which we then add to the balance on your account. <b>Canadian Tire retail card</b> means a credit card that we issue that may only be used to make purchases at retail stores of Canadian Tire Corporation, Limited (and its successors and affiliates) or on its website, or at Canadian Tire gas bars. <b>card</b> means each and every credit card we have issued to you (other than a Canadian Tire retail card or a credit card primarily for business or commercial purposes) and, if you have requested a temporary replacement for any card that you have lost, the term <b>card</b> will include that replacement card even though it has not yet been delivered to you or to a supplementary cardmember. A <b>card</b> will also refer to each credit card that we have issued to a supplementary cardmember. Each reference to a <b>card</b> means each and every card. <b>cash transaction</b> means an advance of cash that is obtained at an automated teller/banking machine <b>(ABM)</b> or from a teller, a balance transfer, any transaction in which you use a convenience cheque, a transaction for gambling purposes (whether at a casino, at a racetrack, over the internet or for the purchase of lottery tickets or any other form of gambling), a money transfer, a purchase of travellers cheques and any other transaction that we notify you is to be treated as a cash transaction. <b>charge</b> means each amount that is charged to a card as a result of any use of the card by you or by any supplementary cardmember (including a charge by way of pre-authorized payments), whether as a result of a purchase or a cash transaction, and includes all interest, fees and other amounts that you are required to pay as provided in this agreement and that are posted to the account for a card. <b>convenience cheque</b> means a cheque that we provide to you for use with a card. <b>credit limit</b> means the maximum amount that may be outstanding on the account for a card at any time. This amount will be set out in the disclosure statement. <b>deferred payment plan</b> means an arrangement that we offer and for which we may charge you a fee that allows you to defer payment on your account for a specific charge, for a period of time that is specified for such charge. <b>disclosure statement</b> means the disclosure statement that we provide to you with a card or when we open an account, as that disclosure statement may be amended or replaced from time to time. <b>equal payments plan</b> means an arrangement that we offer and for which we may charge you a fee that allows you to make payment in respect of a specific charge in twelve <b>(12)</b>approximately equal consecutive monthly instalments (or such greater or lesser number of monthly instalments as we offer), with the last instalment possibly being greater or lesser (each, <b>an equal payments plan instalment</b>), each of which when due will be included in the balance due and the minimum payment for the particular statement period, beginning with the statement period in which the equal payments plan is posted to your account. <b>event of default</b> has the meaning given to that term under the heading “Default” below. <b>PIN</b> means the personal identification number, passcode or password that may be issued or chosen by you or a supplementary cardmember for use in connection with a card. <b>purchase</b> means a charge that is not a cash transaction, interest or fees. special payment plan includes a deferred payment plan, an equal payments plan and any other special financing arrangement that we may offer to you under this agreement subject to any additional terms and conditions that apply to the particular plan. <b>special payment plan termination event</b> means, unless specified otherwise in any additional terms and conditions that apply to the particular plan, the occurrence of one of the following events:<br><ul><li>we do not receive the full amount of the minimum payment due on a statement within <b>59</b> days of the date of that statement, or</li><li>an event of default, other than because of failure to make a payment when due under this agreement.</li></ul><br><b>supplementary cardmember</b> means any person to whom we have issued a credit card on your account at your request. <b>use of the card</b> means the presentation of the card to someone or the disclosure of an account number or card number to someone in person, over the telephone, by fax or other electronic transmission, over the internet or in any other way, in order to make a purchase or to conduct a cash transaction.",
    chooseProduct_CanadianTireAgreement_para3           : "<b><U>Use of the Card</U></b><br>As the primary cardmember you must pay us for all charges made to a card whether as a result of the use of the card by you, any supplementary cardmember or by anyone who you allow to use your card and/or PIN. You may also be liable for certain unauthorized transactions (see Lost/Stolen Cards and Unauthorized Use below). You must not use a card for any unlawful purpose, including purchasing goods or services that are illegal to purchase. You are also responsible for making sure that all supplementary cardmembers comply with this agreement. A card allows you to obtain credit from us, up to your credit limit, by using the card to make purchases from merchants who accept the card and, subject to our discretion, to enter into cash transactions with us and others who accept the card. We cannot, however, guarantee that a card will be accepted wherever you want to use it, and we are not liable to you if we or anyone else refuses to accept a card or a convenience cheque. A stop payment on a convenience cheque is not permitted. Even though you, a supplementary cardmember or anyone else authorized to use a card may not sign a sales slip or other writing when the card is used or uses the card after its expiry date, you will still be responsible for all charges arising from that use of the card. We may at any time restrict or block the ability to use a card for a purchase or cash transaction if we have any concern as to the use of the card, your ability to make any payment to us or for any other reason.",
    chooseProduct_CanadianTireAgreement_para4           : "<b><U>Lost/Stolen Cards and Unauthorized Use</U></b><br> You must take reasonable care to keep your card and any convenience cheques safe from loss, theft or misuse. You must not allow anyone else to use a card, other than a supplementary cardmember, but if you do you will be liable for all charges resulting from such use even if the card was used for transactions that you did not authorize. If your card or any convenience cheque is lost or stolen or used in a fraudulent manner, you are not responsible for any resulting unauthorized or fraudulent charges unless:<ul><li>you did not safeguard your PIN as described below or as we may otherwise advise you from time to time;</li></ul><b>The following and remaining three circumstances enumerated below do not apply to cardholders residing in Quebec:</b><ul><li>you did not take reasonable care to keep your card or convenience cheques safe from loss or theft;</li><li> you did not notify us by telephone promptly after you learned of such loss or theft; or</li><li> you (or any supplementary cardmember) did not fully cooperate with us or law enforcement agencies in any investigation of such unauthorized or fraudulent use or you refused to execute any document that we require in connection with any investigation.You must keep your PIN separate from your card and never let anyone know your PIN. You must not select a PIN that can be easily discovered. For example, a PIN that is the same as your name, date of birth, telephone number, address or social insurance number or a set of sequential numbers must not be selected. You must notify us immediately if your card has been lost or stolen or if you suspect that someone has discovered your account number or PIN by calling us at our <b>24</b>-hour toll-free number listed on your monthly statement.</li></ul>",
    chooseProduct_CanadianTireAgreement_para5           : "<b><U>Credit Limit</U></b><br>The total amount of unpaid charges on a card (we refer to this as the <b>balance</b> on the card) may not at any time exceed the credit limit unless we allow you to. If you exceed the credit limit, and provided that we comply with any notification requirement applicable to such credit over limit, you must pay us the amount over the credit limit when we ask you, but you must always pay that excess amount in full not later than the due date shown on your account statement. We may reduce your credit limit without notice to you or may increase your credit limit with your consent.",
	
	chooseProduct_CanadianTireAgreement_para6           :  "<b><U>Payments</U></b><br>Each month you must pay us at least the <b>minimum Payment</b> that is shown on your statement by the due date on that statement. The method of calculating the minimum payment will be set out in the disclosure statement. Any balance on a special payment plan will be included in the \“New Balance\” shown on your statement, but will not be included for the purpose of calculating the minimum payment or the balance due until payment of the balance on such special payment plan is due, unless specified otherwise in the plan offering. We may decide to reduce or waive the minimum payment for a particular statement period, but if we do so interest will still accrue on the unpaid balance and will be added to the balance on your next statement period. You may make payments to us by cheque, bank draft or money order that you mail to us, by electronic funds transfer that you arrange through a financial institution in Canada, over the internet or by any other method of which we notify you. We cannot accept cash or coins and if you send them to us we are not responsible for any loss. A payment is not considered to have been made until it is in our possession and has been entered into our payment processing system. To ensure that we always receive your payment prior to the due date you should allow sufficient time for your payment to reach us.",
	chooseProduct_CanadianTireAgreement_para7           : "<b><U>Account Statements</U></b><br> Subject to applicable law, we will provide you with a statement of your account once in each calendar month. The period covered by the statement will be between <b>28</b> and <b>33</b> days, depending on holidays, weekends and the number of days in a particular month. We will mail the statement to the last address that we have for you in our records, or, if you wish, we will provide it to you electronically if we are able to do so. You are responsible for notifying us of any change in your postal or email address so that you can continue to receive your statements on time. If your statement is delayed because of problems with postal service or for any reason of which you are aware, you should contact us by telephone or, if you can, review your statement over the internet, so that you can make the required payment by the due date. You should review your statement carefully and if you think that any charge should not have been made to your account you must notify us of any error within <b>90</b> days of the date that the charge was posted to your account. If you do not, you will have no further right to question that charge, other than those charges for which you are not responsible resulting from the unauthorized or fraudulent use of your card. However, if we have incorrectly credited an amount to your account or understated a charge, we may correct that error at any time.",
	chooseProduct_CanadianTireAgreement_para8           :  "<b><U>How we apply payments and credits</U></b><ul><li> For payments received by us, the following will apply:</li></ul>&#45; each payment on account of the minimum payment will be applied in the following order: <br>&#45; equal payments plan instalment(s) in chronological order beginning with the instalment due under the first equal payments plan<br>&#45; interest charges on the current statement and unpaid interest from previous statements<br>&#45; fees<br>&#45; principal (whether it is a cash transaction or a purchase), beginning with those accruing interest at the lowest rate and ending with those accruing interest at the highest rate<br>&#45; If you pay more than your minimum payment, the amount that is paid in excess of the minimum payment is applied as follows:<br>&#45; First, we group together all transactions that have the same interest rate. For example, all transactions with a particular regular annual rate would be in one group and all transactions with the same promotional special rate of interest would be in another group.<br>&#45; Next, we apply the amount of your payment in excess of the minimum payment to each interest rate grouping in the proportion that such grouping bears to the balance due on your account. For example, if <b>25%</b> of the transactions are in one interest rate grouping and <b>75%</b> in another, the amount in excess of the minimum payment will be applied <b>25/75</b> against those amounts. We measure the proportion on the date that we receive the payment and do not include in the calculation any unbilled charges or balances on equal payments plans or deferred payment plans.<br>&#45; If you pay more than the balance due on your statement, that overpayment will be applied first against unbilled charges as of the date of receipt of payment (proportionately among such charges based on the interest rate applicable to the various charges), then to any balances on special payment plans on the following basis: firstly, proportionately among such balances based on the interest rate applicable to the various balances, secondly, in respect of special payment plans that have the same rate of interest, proportionally based on the balance that each type of plan (e.g. deferred payment plans or equal payments plans) represents of the balance of all special payment plans on the account with that interest rate, and lastly, as between special payment plans of the same type with the same interest rate, chronologically starting with the special payment plan of that type which will expire first.<br>&#45; When you have a credit balance on your account, that balance is applied against charges in the order that they are posted to the account. <br>&#45; Billed charges are always paid ahead of unbilled charges.<br>&#45; If you receive a credit for a charge to your account, we first apply that credit to charges made at merchants in a similar merchant category or, if there is no match, then the credit will be applied using the same method as the minimum payment (see above), although a credit is not treated as a payment either on account of the minimum payment or the balance owing on a statement. If a merchant issues you a credit voucher for a transaction we may not be able to post that credit to your account until the next statement period. In the meantime, interest will still accrue on that charge until the credit has been posted and you must still pay the balance shown on your statement in full in order to avoid having to pay interest on the entire balance of all purchases that appear on your statement for the first time.",
	chooseProduct_CanadianTireAgreement_para9           : "<b><U>Interest</U></b><br><b>Interest rate</b> &#45; You will be charged interest on purchases and other charges at the applicable rate (which is subject to change) that is set out in the disclosure statement for the particular type of charge (each, a <b>regular annual rate</b>), unless we offer you a special rate of interest for a particular charge. Each rate that you are charged will be shown on your account statement.",
	chooseProduct_CanadianTireAgreement_para10          :  "<b>How we calculate interest</b> &#45; Subject to the terms of any special payment plan, interest accrues on each charge from the date of the transaction giving rise to the particular charge, which may be earlier than the date that the charge is posted to your account. We calculate interest daily at a daily interest rate which is equal to the applicable annual interest rate divided by the number of days in the particular calendar year. Interest is calculated at the applicable daily interest rate each day based on the total amount of the particular type of charge that is outstanding on that day, until that particular charge has been paid. How long a charge is outstanding will depend on the order that payments are applied as specified above. We do not pay you interest on any credit balance in your account.",
    chooseProduct_CanadianTireAgreement_para11          :  "<b>How payments affect the interest you pay &#8211; grace period</b>&#8211; If we receive payment of the balance due in full by the due date shown on your statement you will not have to pay interest on any purchases that appear on your statement for the first time or on the balance of any deferred payment plan that expired during the billing period covered by your statement. The due date will be <b>26</b> days after your statement date if you live in Quebec or <b>21</b> days after your statement date if you live elsewhere &#8211; this is what is called the <b>grace period</b>. If your grace period ends on a Saturday, Sunday or a holiday it will be automatically extended to the next business day. The grace period does not apply to any unpaid balance due on a previous statement, cash advances, balance transfers and other cash transactions (and related fees), and so, you will be charged interest on those amounts on each statement until they have been paid in full. This means that additional interest charges could appear on a subsequent statement even though you have paid the balance due on your statement in full. If we do not receive payment of the balance due shown on your statement in full by the due date, you will have to pay interest on the entire balance due that was outstanding each day, until you have paid the balance due on that statement in full. Any unpaid balance due from one statement period (which will include any unpaid interest), together with the interest that has accrued during your current statement period, will form part of the balance due on your next statement. As a result, interest is charged on unpaid interest, which means that interest is compounded monthly.",
    chooseProduct_CanadianTireAgreement_para12          :  "<b>Equal payments plans</b> &#45; Interest will not accrue on the balance outstanding on an equal payments plan unless indicated in the equal payments plan offering. If interest does accrue, it will accrue daily on the balance outstanding from the date of the transaction until that balance has been repaid in full (unless a special payment plan termination event occurs earlier) at the interest rate specified in the plan offering. Interest that has accrued during a statement period will appear on your monthly statement unless the plan offering in question indicates that interest will not be charged if you satisfy certain conditions. If you do not pay all of an equal payments plan instalment by the due date on the particular statement, the amount that is unpaid will no longer form part of the equal payments plan and you will be charged interest on that amount from the day after the date of your next statement at the applicable regular annual rate. If a special payment plan termination event occurs,<br> (i) all equal payments plans on the account will be terminated,<br> (ii) you will then be charged interest on the balances outstanding from all equal payments plans at the applicable regular annual rate from the day after the date of your next statement, and<br>(iii) the balance outstanding on each equal payments plan will form part of the balance due on that statement.",
    chooseProduct_CanadianTireAgreement_para13          :  "<b>Deferred payment plans</b> &#45; Unless indicated in the deferred payment plan offering, interest will not accrue on the balance outstanding on a deferred payment plan until that plan expires or is terminated. If interest does accrue, it will accrue daily on the balance outstanding from the date of the transaction until the deferred payment plan expires (unless a special payment plan termination event occurs earlier) at the interest rate specified in the plan offering. Upon expiry, interest will accrue on the balance outstanding of a deferred payment plan at the applicable regular annual rate. If a special payment plan termination event occurs<br>(i) all deferred payment plans on the account will be terminated,<br> (ii) you will then be charged interest on the balances outstanding from all deferred payment plans at the applicable regular annual rate from the day after the date of your next statement, and<br> (iii) the balance outstanding on each deferred payment plan will form part of the balance due on that statement.",
	chooseProduct_CanadianTireAgreement_para14          :  "<b><U>Cash advances</U></b><br> You may use your card to obtain cash advances at locations worldwide that we specify and (together with a PIN) from those ABMs that bear certain logos printed on your card or that we specify from time to time. We may, however, set a minimum and maximum amount for cash advances or revoke this service at any time without notice to you. Transaction receipts issued at an ABM are for convenience only and in the event of any conflict between our records and such receipt our records will govern and be binding.",
    chooseProduct_CanadianTireAgreement_para15          :  "<b><U>Foreign currency transactions</U></b><br> You must pay us for all charges in Canadian dollars. If charges are made to your card in a currency other than Canadian dollars, the foreign currency will be converted to Canadian dollars before it is posted to your account. Credits to your account involving a foreign currency will also first be converted from the foreign currency to Canadian dollars. Each conversion to Canadian currency will be made at exchange rates equal to the rate established by the credit card network (their logo is printed on the face of your card) through which transactions on your card are processed plus the percentage rate disclosed in the disclosure statement (for charges to your account) or minus such percentage rate (for credits to your account). The exchange rate that is used will be the rate on the date that a charge is posted to the account for your card and may be different from the rate in effect on the date of the transaction that resulted in such charge. As a result of such changes in exchange rates and currency exchange costs, the Canadian dollar amount that is credited to your account for a foreign currency transaction could be less than the Canadian dollar amount that was originally charged to your account for that transaction. For transactions in certain foreign currencies, the credit card network may first convert the foreign currency amounts to US dollars before conversion to Canadian dollars.",
    chooseProduct_CanadianTireAgreement_para16          :  "<b><U>Dealing with merchants</U></b><br> We have no responsibility for the quality of the goods or services that you purchase with your card or if they are not suitable for your purposes. Therefore, if you have any claim or dispute with a merchant relating to any goods or services that have been charged to your card, you must still pay us in full for the charges for those goods or services and then settle your claim or dispute directly with the merchant. If you have a dispute with a merchant that you were overcharged or did not receive the goods or services that you purchased with a card and we agree to credit your account with the amount of the disputed transaction (which we have no obligation to do unless required by applicable law), you must promptly sign and return to us any documents that we require, which could include an assignment to us of the claim that you have against the merchant.",
	chooseProduct_CanadianTireAgreement_para17          :  "<b><U>Recurring payments</U></b><br> If you have arranged for recurring payments to be charged to a card, and your card number or expiry date changes or if your account is cancelled, the credit card network (the logo of which is on the face of your card) may automatically inform those merchants or institutions to whom you make recurring payments of the details of your new card information, so that your automatic bill payments are not interrupted. However, it is your responsibility to confirm whether merchants or institutions to whom you make recurring payments participate in such a program, and, if that is not the case, to notify those merchants and institutions of the new information.",
    chooseProduct_CanadianTireAgreement_para18          :  "<b><U>Cancelling your card – closing an account</U></b><br> You may cancel a card held by a supplementary cardmember or close an account (which automatically cancels all cards issued on that account) at any time, but you will still be required to pay the balance owing on the particular account in accordance with this agreement. We may also cancel a card or close an account at any time without notice to you or to any supplementary cardmember even if an event of default has not occurred under this agreement. We may then require that you immediately repay the balance owing on your account in full with interest at the applicable rate(s). If you cancel a card or close an account or if we do, you must return to us all cards on the same account since all cards are our property. If charges are made to a card even after a card has been cancelled, you must still pay us those charges in accordance with this agreement.",
    chooseProduct_CanadianTireAgreement_para19          :  "<b><U>Default</U></b><br> If (i) you do not make any payment when due under this agreement, <br> (ii) you or any supplementary cardmember does not comply with any term or condition of this agreement or any other agreement that we have with you, <br> (iii) you provided any incorrect or misleading information in any application for a card, <br> (iv) you become insolvent or bankrupt or insolvency proceedings are brought by or against you or you make a proposal to your creditors, <br> (v) any of your property is seized or attached under any legal process, <br> (vi) you die, or <br> (vii) we reasonably believe that you are unable to make a payment or otherwise fulfill your obligations under this agreement (each, an <b>event of default</b>), we may <br> (a) terminate or restrict your rights under, and modify any terms of, this agreement, <br> (b) demand that you pay the balance of your account in full with interest at the applicable rate(s), <br> (c) increase the minimum payment that you must make until further notice, <br> (d) apply any balance that you have in any other account or on deposit with us against the amount that you owe us under this agreement, <br> (e) require that you and every supplementary cardmember return all cards and unused convenience cheques, and <br> (f) exercise all other rights and remedies that are available to us in law. Except if you are a cardholder residing in Quebec, you must pay all legal expenses that we incur to exercise our rights and remedies under this agreement. <br><br><b>For Quebec Residents Only: Clause required under the Consumer Protection Act (Quebec) (Clause of forfeiture of benefit of the term)</b> Before availing himself of this clause, the merchant must forward the consumer a notice in writing and unless he is exempted in accordance with section <b>69</b> of the General Regulation, he must forward him a statement of account. Within <b>30</b> days following the receipt by the consumer of the notice and, where necessary, of the statement of account, the consumer may: <br>(a) either remedy the fact that he is in default; <br>(b) or present an application to the court to have the terms and conditions of payment prescribed in this contract changed. It is in the consumer’s interest to refer to sections <b>104</b> to <b>110</b> of the Consumer Protection Act (chapter P-<b>40.1</b>) as well as section <b>69</b> of the General Regulation made under that Act and, where necessary, to contact the Office de la protection du consommateur.",
	chooseProduct_CanadianTireAgreement_para20          :  "<b><U>Optional Services</U></b><br> From time to time we may offer you optional services or benefits at additional cost to you, some of which may be provided by someone other than us. Those services will be subject to separate agreements. You acknowledge that we are not liable for any services provided to you by someone else and that any dispute that you have with the provider of those services does not affect your obligation to pay us all amounts in accordance with this agreement. We may at any time modify, withdraw or terminate any such service.",
    chooseProduct_CanadianTireAgreement_para21          :  "<b><U>Loyalty Programs</U></b><br> In some cases a loyalty program may be provided with a card, in some situations at no additional cost to you. The principal features of any loyalty program will be described in a benefits guide that accompanies the card. If you wish to see a complete set of the terms and conditions that apply to a particular loyalty program you may view them online at the website identified in the benefits guide or you may call one of our Customer Service Representatives at the toll-free number set out in the benefits guide. Loyalty programs may be subject to cancellation or change as provided for in the relevant loyalty program terms.",
    chooseProduct_CanadianTireAgreement_para22          :  "<b><U>Fees and charges</U></b><br> The disclosure statement sets out the fees and charges (including, when applicable, charges for cheques and pre-authorized payments that are dishonoured) that you must pay relating to your card. We will notify you if we add any fee or charge or change the amount of any fee or charge.",
 	chooseProduct_CanadianTireAgreement_para23          :  "<b><U>Assignment of this agreement</U></b><br> We may assign any one or more of your accounts and all of our rights under this agreement related to each assigned account to any other entity or person without your consent.",
    chooseProduct_CanadianTireAgreement_para24          :  "<b><U>Changes to this agreement</U></b><br> We may make a change to any provision of this agreement, including any of the information provided in your initial disclosure statement, at any time, on <b>30</b> days prior notice to you or such longer period of time as may be required by law. We will communicate any changes to you by mail, including by a notice on your statement, or e-mail to the address to which we send your statements. It is your responsibility to let any supplementary cardmember know of any changes to this agreement. A change could apply to a charge that was made before you receive any notice from us, but any change will only take effect from the date that we specify in the notice that we give to you. If you reside in Quebec, you may refuse the change and terminate this agreement without cost, penalty or cancellation indemnity by sending us a notice to that effect no later than <b>30</b> days after the change comes into force. If you choose to terminate the agreement, you will remain responsible for any amounts outstanding under this agreement.",
	chooseProduct_CanadianTireAgreement_para25          :  "<b><U>Changing your address</U></b><br> In order to receive your statements and other communication from us on time you must notify us promptly if you change your address (including your e-mail address if you are receiving your statements electronically).",
    chooseProduct_CanadianTireAgreement_para26          :  "<b><U>Governing laws</U></b><br> The courts of the province or territory in Canada where you reside (or Ontario, if you reside outside Canada) will have exclusive jurisdiction over disputes arising in connection with this agreement, and in determining those disputes, you agree that such courts will apply the laws in force in that province or territory. This agreement is entered into in Welland, Ontario.",
	chooseProduct_CanadianTireAgreement_para27          :  "<b><U>Non-waiver</U></b><br>Even though we accept payment from you or do not exercise any right or remedy that we have under this agreement or insist on full compliance by you of your obligations under this agreement, we may still at any other time exercise all of our rights and remedies under this agreement unless we have agreed in writing not to do so.",
    chooseProduct_CanadianTireAgreement_para28          :  "<b><U>Severability</U></b><br> If any provision of this agreement is found to be unenforceable, that will not affect our ability to enforce the remainder of this agreement.<br><br> <b><U>Language</U></b><br> It is the express wish of the parties that this agreement and all related documents be drawn up in English. Les parties ont exprimé la volonté expresse que cette convention et tous les documents s’y rattachant soient rédigés en anglais.<br><br>",
	chooseProduct_CanadianTireAgreement_para29          :  "<b>Additional Information for Residents of Quebec Clause required under the Consumer Protection Act (Quebec) (Contract extending variable credit for the use of a credit card)</b><br> &#8220;(<b>1</b>) If the consumer uses all or part of the credit extended to make full or partial payment for the purchase or the lease of goods or for a service, the consumer may, if the open credit contract was entered into on the making of and in relation to the sale, lease or service contract, and if the merchant and the open credit merchant collaborated with a view to granting credit, plead against the lender any ground of defence urgeable against the merchant who is the vendor, lessor, contractor or service provider. The consumer may also, in the circumstances described in the first paragraph, exercise against the open credit merchant, or against the merchant’s assignee, any right exercisable against the merchant who is the vendor, lessor, contractor or service provider if that merchant is no longer active or has no assets in Quebec, is insolvent or is declared bankrupt. The open credit merchant or the merchant’s assignee is then responsible for the performance of the obligations of the merchant who is the vendor, lessor, contractor or service provider up to the amount of, as the case may be, the debt owed to the open credit merchant at the time the contract is entered into, the debt owed to the assignee at the time it was assigned to him or the payment the open credit merchant received if he assigned the debt. <br><br>(<b>2</b>) A consumer who is solidarily liable with another consumer for the obligations arising from an open credit contract is released from the obligations resulting from any use of the open credit account after notifying the merchant in writing that he will no longer use the credit extended and no longer intends to be solidarily liable for the other consumer’s future use of the credit extended in advance, and after providing proof to the merchant, on that occasion, that he informed the other consumer by sending him a written notice to that effect at his last known address or technological address. Any subsequent payment made by the consumer must be applied to the debts contracted before the notice was sent to the merchant. <br> <br> (<b>3</b>) A consumer who has entered into a preauthorized payment agreement with a merchant under which payments are made out of credit obtained under a credit card contract may end the agreement at any time by sending a notice to the merchant. On receipt of the notice, the merchant must cease to collect the preauthorized payments. On receipt of a copy of the notice, the card issuer must cease debiting the consumer’s account to make payments to the merchant. <br><br>(<b>4</b>) The consumer is not liable for debts resulting from the use of a credit card by a third person after the card issuer has been notified, by any means, of the loss, theft or fraudulent use of the card or of any other use of the card not authorized by the consumer. Even if no notice was given, consumer liability for the unauthorized use of a credit card is limited to <b>$50.</b> The consumer is held liable for the losses incurred by the card issuer if the latter proves that the consumer committed a gross fault as regards the protection of the related personal identification number. <br><br>(<b>5</b>) Without delay at the end of each period, the merchant must send the consumer a statement of account. The merchant is not required to send a statement of account to the consumer at the end of any period if there have been no advances or payments during the period and the outstanding balance at the end of period is zero. <br><br>(<b>6</b>) If the consumer makes a payment at least equal to the outstanding balance at the end of the preceding period within <b>21</b> days after the date of the end of the period, no credit charges may be required from the consumer on that outstanding balance, except as regards money advances. In the case of a money advance, charges may accrue as of the date of the advance until the date of payment. <br><br>(<b>7</b>) The consumer may demand that the merchant send, without charge, a copy of the vouchers for each of the transactions charged to the account during the period covered by the statement. The merchant must send the copy of the vouchers requested within <b>60</b> days after the date the consumer’s request was sent. <br><br>(<b>8</b>) Until the consumer receives a statement of account at his address or technological address if expressly authorized by the consumer, the merchant must not claim credit charges on the unpaid balance, except as regards money advances. It is in the consumer’s interest to refer to sections <b>103.1, 122.1, 123, 123.1, 124, 126, 126.2, 126.3, 127</b> and <b>127.1</b> of the Consumer Protection Act (chapter <b>P-40.1</b>) and, if further information is necessary, to contact the Office de la protection du consommateur.&#8221;",
    chooseProduct_CanadianTireAgreement_para30          :  "<b>Table of Credit Charges</b><br> Examples of credit charges (rounded to the nearest cent) assuming that all charges are purchases bearing interest at the regular annual rates specified below, a <b>30</b> day month, no charges made on special payments plans and no other fees, additional payments or other charges: <br><br>Annual<br> Rate<br><br>Average Balance<br> $100 $500 $1000 $2000 <br>19.99% $1.64 $8.22 $16.34 $32.86<br> 21.99% $1.81 $9.04 $18.07 $36.15",
    chooseProduct_CanadianTireAgreement_para31          :  "<center><b>Privacy and Your Personal Information</b></center><br>Personal Information about you is collected, used, and disclosed in accordance with the Canadian Tire Privacy Charter (<b>Privacy Charter</b>), including, in particular, to <br>(a) process your application for a product or to provide a service; <br>(b) assess and update your credit-worthiness on an ongoing basis; <br>(c) process, service, analyze and audit your relationship with us, including collecting any monies you owe us; <br>(d) verify your identity and protect against error and fraud: <br>(e) administer the delivery, return or exchange of products, services, rewards and programs to you; <br>(f) determine your interest and eligibility for, and where appropriate provide you with products, services, rewards and programs; <br>(g) comply with applicable legal, regulatory and self-regulatory requirements; and <br>(h) better understand your product and services needs and to offer relevant information, products, service and rewards to meet those needs. As described in the Privacy Charter, Personal Information may be shared with other parties who administer accounts and with other members of the Canadian Tire family of companies to develop surveys, contests, individual and direct marketing programs and may be used to market and sell other products and services to you including by way of postal mail, e-mail, facsimile, telephone, text message, or other form of electronic message. If you decide that you do not want to receive marketing offers for products and services, you may always withdraw or refuse your consent by clicking on the unsubscribe link in our email communications or by contacting us at 1-866-846-5841. Your request will be promptly processed but may not be in time to remove you from promotions already in progress. Please note that even if you have opted out of receiving marketing communications, we may still contact you for purposes of administering your account and sending you transactional or operational messages. The Privacy Charter is updated from time to time. You may obtain the most current version of the Privacy Charter online at www. ctfs.com or by calling us at 1-800-459-6415. When your personal information is transferred to a Service Provider, we require them to protect the information in a manner that is consistent with our Privacy Charter. Our service providers may be located outside Canada and may be required to disclose your personal information under the laws of their jurisdictions.",
    chooseProduct_CanadianTireAgreement_para32          :  "<center><b>Complaint Resolution Process</b></center><br> At Canadian Tire Bank, we are committed to building lifetime relationships with our customers by providing superior customer service. When you have a concern or complaint, we encourage you to tell us about it by following our Complaint Resolution Process below. Start at step 1 and if at any time your concern is not resolved to your satisfaction, <b><U>only then</U></b> proceed to the next step. <br><br><b>Step 1</b><br> The first step to resolving a complaint is to contact us  directly. The Customer Relationship Representatives will attempt to resolve your concerns within step 1, and, as appropriate, they will escalate your concerns to other levels within step 1, such as an Account Supervisor or Supervisor within the applicable contact centre. You may contact us by calling 1-866-846-5841. If it is more convenient, you may fax your complaint to 905-735-2644 or write to us at:<br> Canadian Tire Bank<br> P.O. Box 12000 Station Main<br> Welland, ON L3B 6C7<br><br><b>Step 2</b><br> If your complaint is not resolved to your satisfaction within step 1, you may ask to have your concerns escalated to step 2, which is the Manager level and above, by calling 1-866-846-5841 and asking to speak to someone at the Manager level or above. They will make every effort to resolve your concerns and let you know when you can expect a response. If it is more convenient, you may fax your complaint to 905-735-2644 or write to us at the above noted address.<br><br> <b>Step 3</b><br> The final escalation point is the Canadian Tire Bank Ombudsman’s office. If you are not satisfied with the resolution that was provided in step 2, you may direct your complaint to the Canadian Tire Bank Ombudsman’s office. You may contact the Canadian Tire Bank Ombudsman’s office by phone at 1-800-464-9166, ext. 39583, by fax at 905-465-6033 or in writing at:<br> Ombudsman<br> Canadian Tire Bank<br> 3475 Superior Court<br> Oakville, ON L6L 0C6<br> If the steps listed above have not resolved your concern or complaint to your satisfaction or 90 days have elapsed since we received your complaint at step 2, you may contact the external Ombudsman for Banking Services and Investments (&#8220;OBSI&#8221;) by phone or in writing at: Ombudsman for Banking Services and Investments <br>401 Bay Street<br> Suite 1505, P.O. Box 5<br> Toronto, ON M5H 2Y4<br> Telephone: 1-888-451-4519<br> Fax: 1-888-422-2865<br>Email: <b>ombudsman@obsi.ca</b><br> Please visit <b>www.obsi.ca</b> for more information about OBSI. If you have a complaint about any obligation of Canadian Tire Bank under a consumer provision of the Bank Act, you may file a written complaint with the Financial Consumer Agency of Canada (&#8220;FCAC&#8221;) at:<br> Financial Consumer Agency of Canada Enterprise Building<br> 427 Laurier Avenue West, 6th Floor<br> Ottawa, ON K1R 1B9<br> Telephone: 1-866-461-3222<br> Fax: 1-866-814-2224<br> Please visit <b><U>www.fcac-acfc.gc.ca</U></b> for more information about FCAC. For information on privacy related concerns or complaints, please review our Privacy Charter and Frequently Asked Questions at www.ctfs.com. If you have any questions on this agreement, please call our customer service at 1-866-846-5841.",
...
"<p><b>For the Triangle Mastercard only:</b> If you are not approved for a card at the above rates, Canadian Tire Bank may still issue you a card at the following annual interest rate: <strong>21.99%</strong> for all charges.</p>",
    ...
    // US3381
    overview_EffectiveDate						:	"Information effective as of <b>June 1, 2021.</b>",
...
//    personalData_DR 									: 	"DR",
	...
	// VZE-87
	optionalProducts_SignatureAgreement_CP_subTitle				:	"<p>By signing and checking the box below, I agree to enrol in the Optional Product below and I accept the <span style=\"font-size: 13pt;\";><strong>monthly premium of $1.10/$100 of my average daily balance</strong></span> that will be charged to my Canadian Tire Bank issued Mastercard.</p><p>Residents of Quebec: I also confirm that I have been provided with and have reviewed the Summary and Fact Sheet.</p>",
	optionalProducts_SignatureAgreement_IW_subTitle				:	"<p>By signing and checking the box below, I agree to enrol in the Optional Product below and I accept the <span style=\"font-size: 13pt;\";><strong>monthly subscription fee of $4.99 + taxes</strong></span> that will be charged to my Canadian Tire Bank issued Mastercard.</p>",
  ...
  //................................................................End Terms and Conditions for Identity Watch Classic.......................
	...
	// VZE-87
	optionalProducts_TermsAndConditions_16_CP				:	"I have read and understand the product details, terms and conditions and give my consent to be enrolled in <span style=\"font-size: 13pt;\";><strong>Credit Protector<span class=\"optionaProduct_cp_iw_sup\">&reg;</span> Insurance</span></strong>.",
	optionalProducts_TermsAndConditions_16_IW              :    "I have read and understand the product details, terms and conditions and give my consent to be enrolled in <span style=\"font-size: 13pt;\";><strong>Identity Watch Classic</span></strong>.",            
	...
	optionalProducts_CPProducts							:   "<ul><li><span style=\"font-size: 14pt;\";><strong>Credit Protector<sup>&reg;</sup> Insurance</span></strong></li></ul>",
	optionalProducts_IWProducts							:   "<ul><li><span style=\"font-size: 14pt;\";><strong>Identity Watch Classic</span></strong></li></ul>",
