...
WICI.dictionary_fr =  {
	...
	overview_CostOfCreditDisclosure_Title			:   "Déclaration sur le coût du crédit pour les demandes de carte de crédit",
	...
	overview_CostOfCreditDisclosure_Right1   	:   "<p>Les taux d'intérêt ci-dessous seront en vigueur à compter de la date d'ouverture de votre compte : <br><br>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <strong>19,99%</strong></p> <p>Transactions au comptant ( par exemple : avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <strong>22,99%</strong></p> <p>Si votre demande de carte à ce taux n'est pas approuvée, il se peut que la Banque Canadian Tire accepte d'émettre une carte à votre nom portant un taux d'intérêt annuel de <strong>25,99%</strong> pour toutes les transactions (à l’exception des transactions au comptant et des frais afférents) et de <strong>27,99%</strong>pour les transactions au comptant et les frais afférents.</p>",
	...
	overview_CostOfCreditDisclosure_Left4    	:   "Conversion de devise",
	...
	*/	
    ...
    PA_P_Fulfillment                                  :   "Exécution responsable de l’exécution des commandes",
    ...
    PA_P_the_iw_program                               :   "Le programme Surveillance d’identité Classique est commandité par la Banque Canadian Tire et fourni par Fidélisation propriétaire Sigma Loyalty Group Inc. (« Sigma »).",
  ...
  //--CP offer details ends
    ...
    OP_IW_P_classic_program                           :   "Le programme Surveillance d’identité Classique est commandité par la Banque Canadian Tire et fourni par Sigma Loyalty Group Inc. (« Sigma »).",
    ...
    OP_FT_internet                                    :   "<span class=\"footer_p_sup\">MD/MC</span> Suivi des informations personnelles sur Internet<span class=\"footer_p_sup\">MD</span>, iPiP<span class=\"footer_p_sup\">MD</span>, et Retour<span class=\"footer_p_sup\">MD</span> sont des marques de commerce déposées de Fidélisation propriretaire Aimia Canada Inc.",
    OP_FT_assurant                                    :   "<span class=\"footer_p_sup\">MD</span> Assurant est une marque de commerce déposée d’Assurant Inc.",
    OP_FT_mastercard                                  :   "<span class=\"footer_p_sup\">MD/MC</span> Mastercard, World Mastercard, Secure Code et Cirrus sont des marques déposées, et le logo des deux cercles imbriqués est une marque de commerce de Mastercard International Incorporated.",
    ...
    */
    ...
    legal_omc_sixth_chapter 							: "<span class=\"MD\"><sup></sup></span> Mastercard, World Mastercard, Mastercard SecureCode et Cirrus sont des marques de commerce déposées , et le logo des deux cercles imbriqués est une marque de commerce de Mastercard International Incorporated.",
    ...
    omc_second_chapter_ectm								: "Demandez la carte Mastercard Options de Canadian Tire dès aujourd'hui. C'est une façon plus rapide d'obtenir de l'« Argent » Canadian Tire.</br> Utilisez tout simplement la carte partout où vous magasinez – elle est acceptée dans le monde entier par des millions de commerçants.",
    ...
    legal_omc_second_chapter_ectm                       : "<sup>2</sup> Un montant d'achat d'essence minimum peut être requis. Le taux peut varier d'un poste d'essence à l'autre. Le taux auquel vous obtenez des primes en « Argent » électronique Canadian Tire partout ailleurs est de 2x les primes, ce qui équivaut à peu près à 0,8 %. L’« Argent » Canadian Tire électronique est calculé à partir du montant de l’achat avant taxes dans les magasins Canadian Tire et PartSource. Services Financiers Canadian Tire est une dénomination commerciale de la Banque Canadian Tire.",
