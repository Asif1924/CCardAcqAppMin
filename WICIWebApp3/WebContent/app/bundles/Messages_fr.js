...
WICI.dictionary_fr =  {
  ...
  //  chooseProduct_Triangle_Rewards 					  : 						"Triangle &nbsp;&nbsp;  Rewards<sup>&trade;</sup>",
	...
	overview_CostOfCreditDisclosure_Right1   	:   "<p>Les taux d'intérêt ci-dessous seront en vigueur à compter de la date d'ouverture de votre compte : <br><br>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <strong>19,99%</strong></p> <p>Transactions au comptant ( par exemple : avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <strong>22,99%</strong></p> <p> Uniquement pour la carte Mastercard<sup style='font-size: .5em;'>MD</sup> Triangle<sup style='font-size: .5em;'>MC</sup>, si votre demande de carte à ce taux n'est pas approuvée, il se peut que la Banque Canadian Tire accepte d'émettre une carte à votre nom portant un taux d'intérêt annuel de <strong>25,99%</strong> pour toutes les transactions (à l’exception des transactions au comptant et des frais afférents) et de <strong>27,99%</strong>pour les transactions au comptant et les frais afférents.</p>",
	overview_CostOfCreditDisclosure_OMZ_Right1    : "<p>Les taux d'intérêt ci-dessous seront en vigueur à compter de la date d'ouverture de votre compte : <br><br>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <strong>19,99%</strong></p> <p>Transactions au comptant ( par exemple : avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <strong>22,99%</strong></p> <p>Si votre demande de carte à ce taux n’est pas approuvée, il se peut que la Banque Canadian Tire accepte d’émettre une carte à votre nom portant un taux d’intérêt annuel de <strong>25,99%</strong> pour toutes les transactions (à l’exception des transactions au comptant et des frais afférents) et de <strong>27,99%</strong> pour les transactions au comptant et les frais afférents.</p>", 
    ...
    overview_CostOfCreditDisclosure_ChooseProduct_Right1 :"<p>Les taux d'intérêt ci-dessous seront en vigueur à compter de la date d'ouverture de votre compte : <br><br>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <strong>19,99%</strong></p> <p>Transactions au comptant ( par exemple : avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <strong>22,99%</strong></p> <p>  Pour la carte Mastercard<sup style='font-size: .5em;'>MD</sup> Triangle<sup style='font-size: .5em;'>MC</sup>, si votre demande de carte à ce taux n'est pas approuvée, il se peut que la Banque Canadian Tire accepte d'émettre une carte à votre nom portant un taux d'intérêt annuel de <strong>25,99%</strong> pour toutes les transactions (à l’exception des transactions au comptant et des frais afférents) et de <strong>27,99%</strong>pour les transactions au comptant et les frais afférents.</p>",
  ...
  //--CP offer details ends
	...
	*/
	...
	signatureScreen_License1_2                        :                         " avec un taux d'intérêt annuel de 19,99 % pour tous les debits portés à mon compte, à l’exception des transactions au comptant et des frais afférents et un taux d'intérêt annuel de 22,99 % pour les transactions au comptant et les frais afférents.",
