...
WICI.dictionary_fr =  {
  ...
  //  chooseProduct_Triangle_Rewards 					  : 						"Triangle &nbsp;&nbsp;  Rewards<sup>&trade;</sup>",
	...
	overview_CostOfCreditDisclosure_Right1   	:   "<p>Les taux d'intérêt ci-dessous seront en vigueur à compter de la date d'ouverture de votre compte : <br><br>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <strong>19,99 %</strong></p> <p>Transactions au comptant (avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <strong>22,99 %</strong></p> " +
													"<p><b>Pour les cartes Mastercard<sup style='font-size: .5em;'>MD</sup> Triangle<sup style='font-size: .5em;'>MC</sup>, Mastercard<sup style='font-size: .5em;'>MD</sup> Avantage Essence<sup style='font-size: .5em;'>MD</sup> et Mastercard<sup style='font-size: .5em;'>MD</sup> Avantage Remise<sup style='font-size: .5em;'>MD</sup> uniquement :</b>" + 
													"<br><br>Si votre demande de carte aux taux susmentionnés n’est pas approuvée, il se peut que la Banque Canadian Tire accepte d’émettre une carte à votre nom aux taux d’intérêt annuels suivants :" +
													"<br><br>(i) si vous êtes un résident du Québec, <strong>22,99 %</strong> pour tous les débits;" +
													"<br><br>(ii) si vous résidez ailleurs qu’au Québec, <strong>25,99 %</strong> pour tous les débits (à l’exception des transactions au comptant et des frais afférents) et <strong>27,99 %</strong> pour les transactions au comptant et les frais afférents.</p>",
	overview_CostOfCreditDisclosure_OMZ_Right1    : "<p>Les taux d'intérêt ci-dessous seront en vigueur à compter de la date d'ouverture de votre compte : <br><br>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <strong>19,99 %</strong></p> <p>Transactions au comptant (avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <strong>22,99 %</strong></p>" + 
													"<b>Pour les cartes Mastercard<sup style='font-size: .5em;'>MD</sup> Triangle<sup style='font-size: .5em;'>MC</sup>, Mastercard<sup style='font-size: .5em;'>MD</sup> Avantage Essence<sup style='font-size: .5em;'>MD</sup> et Mastercard<sup style='font-size: .5em;'>MD</sup> Avantage Remise<sup style='font-size: .5em;'>MD</sup> uniquement :</b> " +
													"<br><br>Si votre demande de carte aux taux susmentionnés n’est pas approuvée, il se peut que la Banque Canadian Tire accepte d’émettre une carte à votre nom aux taux d’intérêt annuels suivants :" +
													"<br><br>(i) si vous êtes un résident du Québec, <strong>22,99 %</strong> pour tous les débits;" +
													"<br><br>(ii) si vous résidez ailleurs qu’au Québec, <strong>25,99 %</strong> pour tous les débits (à l’exception des transactions au comptant et des frais afférents) et <strong>27,99 %</strong> pour les transactions au comptant et les frais afférents.", 
	...
	overview_CostOfCreditDisclosure_Right6   	:   "<p><span style=\"font-size: 12pt;\";><strong>Frais d’avances de fonds : 4 $</strong></span> — Facturés à la date à laquelle la transaction est inscrite à votre compte." +
													...
													"<span style=\"font-size: 12pt;\";><strong>Administration du solde créditeur :</strong></span> Le moindre de <span style=\"font-size: 12pt;\";><strong>10 $</strong></span> ou du montant de votre solde créditeur. Imputés le dernier jour d’une période de facturation lorsque le compte comporte un solde créditeur et qu’il a été inactif au cours des <span style=\"font-size: 12pt;\";><strong>12</strong></span> périodes de facturation précédentes.</p>",
	...
	// US3381
	overview_EffectiveDate						:	"Renseignements en vigueur le <b>13 juin 2019.</b>",
    ...
    overview_CostOfCreditDisclosure_ChooseProduct_Right1 :"<p>Les taux d'intérêt ci-dessous seront en vigueur à compter de la date d'ouverture de votre compte : <br><br>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <strong>19,99 %</strong></p> <p>Transactions au comptant (avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <strong>22,99 %</strong></p> " +
    													  "<p><b>Pour les cartes Mastercard<sup style='font-size: .5em;'>MD</sup> Triangle<sup style='font-size: .5em;'>MC</sup>, Mastercard<sup style='font-size: .5em;'>MD</sup> Avantage Essence<sup style='font-size: .5em;'>MD</sup> et Mastercard<sup style='font-size: .5em;'>MD</sup> Avantage Remise<sup style='font-size: .5em;'>MD</sup> uniquement : </b>" +
    													  "<br><br>Si votre demande de carte aux taux susmentionnés n’est pas approuvée, il se peut que la Banque Canadian Tire accepte d’émettre une carte à votre nom aux taux d’intérêt annuels suivants :" + 
    													  "<br><br>(i) si vous êtes un résident du Québec, <strong>22,99 %</strong> pour tous les débits;" +
    													  "<br><br>(ii) si vous résidez ailleurs qu’au Québec, <strong>25,99 %</strong> pour tous les débits (à l’exception des transactions au comptant et des frais afférents) et <strong>27,99 %</strong> pour les transactions au comptant et les frais afférents.</p>",
   overview_CostOfCreditDisclosure_ChooseProduct_Right1_OMX	:	"Les taux d'intérêt ci-dessous seront en vigueur à compter de la date d'ouverture de votre compte : <br><br>Tous les débits portés à votre compte (à l’exception des transactions au comptant et des frais afférents) : <span style=\"font-size: 12pt;\";><strong>19,99 %</strong></span></p> <p>Transactions au comptant (avances de fonds, transferts de solde, chèques de commodité, transferts de fonds, achats de chèques de voyage et transactions liées aux jeux de hasard) et frais afférents : <span style=\"font-size: 12pt;\";><strong>22,99 %</strong></span></p> " +
   																"<b>Pour les cartes Mastercard<sup style='font-size: .5em;'>MD</sup> Triangle<sup style='font-size: .5em;'>MC</sup>, Mastercard<sup style='font-size: .5em;'>MD</sup> Avantage Essence<sup style='font-size: .5em;'>MD</sup> et Mastercard<sup style='font-size: .5em;'>MD</sup> Avantage Remise<sup style='font-size: .5em;'>MD</sup> uniquement :</b> " +
																"<br><br>Si votre demande de carte aux taux susmentionnés n’est pas approuvée, il se peut que la Banque Canadian Tire accepte d’émettre une carte à votre nom aux taux d’intérêt annuels suivants :" +
																"<br><br>(i) si vous êtes un résident du Québec, <span style=\"font-size: 12pt;\";><strong>22,99 %</strong></span> pour tous les débits;" +
																"<br><br>(ii) si vous résidez ailleurs qu’au Québec, <span style=\"font-size: 12pt;\";><strong>25,99 %</strong></span> pour tous les débits (à l’exception des transactions au comptant et des frais afférents) et <span style=\"font-size: 12pt;\";><strong>27,99 %</strong></span> pour les transactions au comptant et les frais afférents.",    													  
  ...
  //--CP offer details ends
	...
	*/
	...
	signatureScreen_License1_2                        :                         " avec un taux d'intérêt annuel de <span style=\"font-size: 12pt;\";><strong>19,99 %</strong></span> pour tous les debits portés à mon compte, à l’exception des transactions au comptant et des frais afférents et un taux d'intérêt annuel de <span style=\"font-size: 12pt;\";><strong>22,99 %</strong></span> pour les transactions au comptant et les frais afférents.",
 ...
 // AgentAttribution screen STARTS
    ...
    */
    ...
    // signatureScreen_License2                            : "<b>S'il ne vous est pas possible d'approuver ma demande de carte prévoyant un taux d'intérêt annuel de 21,99 % pour les avances de fonds et les frais afférents et un taux d'intérêt annuel de 19,99 % pour tous les autres types de débit, j'accepte que vous traitiez la présente demande, sans que vous ayez à m'en aviser spécifiquement, comme s'il s'agissait d'une demande de carte à un taux d'intérêt annuel de 25,99 % pour tous les types de débit, à l'exclusion des avances de fonds et des frais afférents pour lesquels le taux d'intérêt annuel sera de 27,99 %.</b>",
     signatureScreen_License2                            :  "<b>Si votre demande de carte n’est pas approuvée aux taux susmentionnés, la Banque Canadian Tire peut émettre une carte aux taux d’intérêt annuels suivants :" + 
															"<br><br>(i) si vous êtes un résident du Québec, 22,99 % pour tous les frais ; ou" + 
															"<br><br>(ii) si vous résidez à l'extérieur du Québec, 25,99 % pour tous les frais (à l’exception des transactions au comptant et des frais afférents) et de 27,99 % pour les avances de fonds et les frais afférents.</b>",
