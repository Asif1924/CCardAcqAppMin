...
WICI.PrinterErrorDialog = function(errorMessage, message, title, buttonLabel, callback, uiDecoration, dialogTemplate) {
	var itemizedList;
	var liClass;
	...
	function appendDialog(){
		$("#printerErrorMessageDialog-template").template("dialogTemplate");
		$.tmpl("dialogTemplate", {
			title : title,
			message : message,
