...
WICI.QCDistributionGuideMessageDialoge = function(message, yesCallback, noCallback, title, yesButton, noButton){
	...
	function appendDialog(){
		$("#QCDistributionGuideMessageDialog-template").template("dialogTemplate");
		$.tmpl("dialogTemplate", {
			title : title,
			message : message,
			yesButton : yesButton,
