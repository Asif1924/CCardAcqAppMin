...
WICI.IdNumberValidation = function() {                                       
	this.data = [
	             { prov : 'AB', idTypes : ['DR','AB' ],     idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,9}$/ },
	             { prov : 'AB', idTypes : ['HE'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{8,}$/ },
	             { prov : 'AB', idTypes : ['BI'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{6,}$/ },
	             { prov : 'BC', idTypes : ['DR'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{7}$/}, 
	             ...
	             { prov : 'MB', idTypes : ['DR'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{3,}$/}, 
	             { prov : 'NB', idTypes : ['DR','NB'],      idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,7}$/ },
	             ...
	             { prov : 'NL', idTypes : ['NL'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,}$/ },
	             { prov : 'NT', idTypes : ['NT','BI','DR',],idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,}$/ },
	             { prov : 'NS', idTypes : ['BI'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,}$/ } ,
	             { prov : 'NS', idTypes : ['NS'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{10,}$/ } ,
	             { prov : 'NU', idTypes : ['BI','NU'],      idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,}$/ } ,
	             { prov : 'NU', idTypes : ['DR'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,9}$/ } ,
	             { prov : 'NU', idTypes : ['HE'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{8,}$/ } ,
	             { prov : 'ON', idTypes : ['BI'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{10,}$/ }, 
	             { prov : 'ON', idTypes : ['ON'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{8,}$/ }, 
	             { prov : 'PE', idTypes : ['PE'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,}$/ },
	             { prov : 'PE', idTypes : ['BI'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{8,}$/ },
	             { prov : 'PE', idTypes : ['DR'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{4,6}$/ },
	             { prov : 'QC', idTypes : ['BI'],           idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{10,}$/ } ,
	             { prov : 'YT', idTypes : ['YT','BI','DR'], idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{5,}$/ } ,
	             { prov : 'SK', idTypes : ['SK','BI'],      idPostion :null,    regExp: /^[a-zA-Z0-9\-\s]{8,}$/ },
	             ...
	             { prov : 'NS', idTypes : ['DR'],           idPostion : [{firstChar:5, secondChar:6,  datePostion:'D'}, {firstChar:7, secondChar:8,datePostion:'M'},      {firstChar:9, secondChar:10,datePostion:'Y'}],      regExp:  /^[a-zA-Z]{5}[a-zA-Z0-9\-\s]{6,}$/ } ,
